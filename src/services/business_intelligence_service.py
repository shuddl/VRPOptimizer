    ...
    async def get_optimization_metrics(self) -> Dict[str, Any]:
        ...
        try:
            async with self.database.async_session() as session:
                ...
                data = await results.fetchall()  # Add 'await' here
                ...
                df = pd.DataFrame(
                    data, columns=["total_distance", "total_cost", "vehicle_count"]
                )
    ...
    async def get_historical_metrics(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            async with self.database.async_session() as session:
                ...
                result = await session.execute(query, {"start_date": thirty_days_ago})

...
def exec_func_with_error_handling(
    ...
    try:
        ...
        logging.error("RerunException occurred", exc_info=True)
        ...
        logging.error("StopException occurred", exc_info=True)
        premature_stop = True
    except FragmentHandledException:
        logging.error("FragmentHandledException occurred", exc_info=True)

...
class GScipParameters(google.protobuf.message.Message):
    ...
    class _EmphasisEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            GScipParameters._Emphasis.ValueType
        ],
        builtins.type,
    ):
    ...
    class _MetaParamValueEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            GScipParameters._MetaParamValue.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def bool_params(
        self,
    ) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.bool]:
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"print_detailed_solving_stats",
            "print_scip_model",
            b"print_scip_model",
            "real_params",
            b"real_params",
            "scip_model_filename",
            b"scip_model_filename",
            "search_logs_filename",
            b"search_logs_filename",
            "separating",
            b"separating",
            "silence_output",
            b"silence_output",
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_heuristics", b"_heuristics"]
    ) -> typing.Literal["heuristics"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_num_solutions", b"_num_solutions"]
    ) -> typing.Literal["num_solutions"] | None: ...
    @typing.overload
    def WhichOneof(
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_presolve", b"_presolve"]
    ) -> typing.Literal["presolve"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_separating", b"_separating"]
    ) -> typing.Literal["separating"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_silence_output", b"_silence_output"]
    ) -> typing.Literal["silence_output"] | None: ...
...
class GScipSolvingStats(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"dual_simplex_iterations",
            "first_lp_relaxation_bound",
            b"first_lp_relaxation_bound",
            "node_count",
            b"node_count",
            "primal_simplex_iterations",
            b"primal_simplex_iterations",
            "root_node_bound",
            b"root_node_bound",
            "total_lp_iterations",
            b"total_lp_iterations",
        ],
    ) -> None: ...
...
class GScipOutput(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "stats", b"stats", "status", b"status", "status_detail", b"status_detail"
        ],
    ) -> None: ...

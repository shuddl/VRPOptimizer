...
class _CpSolverStatusEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _CpSolverStatus.ValueType
    ],
    builtins.type,
):
...
class IntegerVariableProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["domain", b"domain", "name", b"name"]
    ) -> None: ...
...
class BoolArgumentProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["literals", b"literals"]
    ) -> None: ...
...
class LinearExpressionProto(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "coeffs", b"coeffs", "offset", b"offset", "vars", b"vars"
        ],
    ) -> None: ...
...
class LinearArgumentProto(google.protobuf.message.Message):
    ...
    def exprs(
        ...
        global___LinearExpressionProto
    ]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self, field_name: typing.Literal["exprs", b"exprs", "target", b"target"]
    ) -> None: ...
...
class LinearConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "coeffs", b"coeffs", "domain", b"domain", "vars", b"vars"
        ],
    ) -> None: ...
...
class ElementConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "index", b"index", "target", b"target", "vars", b"vars"
        ],
    ) -> None: ...
...
class IntervalConstraintProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["end", b"end", "size", b"size", "start", b"start"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["end", b"end", "size", b"size", "start", b"start"],
...
class NoOverlapConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["intervals", b"intervals"]
    ) -> None: ...
...
class NoOverlap2DConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "x_intervals", b"x_intervals", "y_intervals", b"y_intervals"
        ],
    ) -> None: ...
...
class CumulativeConstraintProto(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["capacity", b"capacity"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "capacity", b"capacity", "demands", b"demands", "intervals", b"intervals"
        ],
    ) -> None: ...
...
class ReservoirConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        min_level: builtins.int = ...,
        max_level: builtins.int = ...,
        time_exprs: collections.abc.Iterable[global___LinearExpressionProto]
        | None = ...,
        level_changes: collections.abc.Iterable[global___LinearExpressionProto]
        | None = ...,
...
class CircuitConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "heads", b"heads", "literals", b"literals", "tails", b"tails"
        ],
    ) -> None: ...
...
class TableConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "negated", b"negated", "values", b"values", "vars", b"vars"
        ],
    ) -> None: ...
...
class InverseConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal["f_direct", b"f_direct", "f_inverse", b"f_inverse"],
    ) -> None: ...
...
class ConstraintProto(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["constraint", b"constraint"]
    ) -> (
        typing.Literal[
            "bool_or",
            "bool_and",
...
class CpObjectiveProto(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"integer_after_offset",
            "integer_before_offset",
            b"integer_before_offset",
            "integer_scaling_factor",
            b"integer_scaling_factor",
            "offset",
            b"offset",
            "scaling_factor",
            b"scaling_factor",
...
class DecisionStrategyProto(google.protobuf.message.Message):
    ...
    class _VariableSelectionStrategyEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DecisionStrategyProto._VariableSelectionStrategy.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class VariableSelectionStrategy(
        _VariableSelectionStrategy, metaclass=_VariableSelectionStrategyEnumTypeWrapper
    ):
    ...
    class _DomainReductionStrategyEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DecisionStrategyProto._DomainReductionStrategy.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class DomainReductionStrategy(
        _DomainReductionStrategy, metaclass=_DomainReductionStrategyEnumTypeWrapper
    ):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"domain_reduction_strategy",
            "exprs",
            b"exprs",
            "variable_selection_strategy",
            b"variable_selection_strategy",
            "variables",
            b"variables",
        ],
    ) -> None: ...
...
class PartialVariableAssignment(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["values", b"values", "vars", b"vars"]
    ) -> None: ...
...
class SparsePermutationProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "cycle_sizes", b"cycle_sizes", "support", b"support"
        ],
    ) -> None: ...
...
class DenseMatrixProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "entries", b"entries", "num_cols", b"num_cols", "num_rows", b"num_rows"
        ],
    ) -> None: ...
...
class SymmetryProto(google.protobuf.message.Message):
    ...
    def permutations(
        ...
        global___SparsePermutationProto
    ]:
    ...
    def __init__(
        self,
        *,
        permutations: collections.abc.Iterable[global___SparsePermutationProto]
        | None = ...,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "orbitopes", b"orbitopes", "permutations", b"permutations"
        ],
    ) -> None: ...
...
class CpModelProto(google.protobuf.message.Message):
    ...
    def search_strategy(
        ...
        global___DecisionStrategyProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        search_strategy: collections.abc.Iterable[global___DecisionStrategyProto]
        | None = ...,
...
class CpSolverResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        objective_value: builtins.float = ...,
        best_objective_bound: builtins.float = ...,
        additional_solutions: collections.abc.Iterable[global___CpSolverSolution]
        | None = ...,
        tightened_variables: collections.abc.Iterable[global___IntegerVariableProto]
        | None = ...,
        sufficient_assumptions_for_infeasibility: collections.abc.Iterable[builtins.int]
        | None = ...,
    ...
    def HasField(
        self, field_name: typing.Literal["integer_objective", b"integer_objective"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "additional_solutions",
            b"additional_solutions",
            "best_objective_bound",
            b"best_objective_bound",
            "deterministic_time",
            b"deterministic_time",
            "gap_integral",
            b"gap_integral",
            "inner_objective_lower_bound",
            b"inner_objective_lower_bound",
            "integer_objective",
            b"integer_objective",
            ...
            b"sufficient_assumptions_for_infeasibility",
            "tightened_variables",
            b"tightened_variables",
            "user_time",
            b"user_time",
            "wall_time",
            b"wall_time",

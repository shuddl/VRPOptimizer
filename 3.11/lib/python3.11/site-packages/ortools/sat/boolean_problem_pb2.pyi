...
class LinearObjective(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "offset", b"offset", "scaling_factor", b"scaling_factor"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class LinearBooleanProblem(google.protobuf.message.Message):
    ...
    def constraints(
        ...
        global___LinearBooleanConstraint
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        constraints: collections.abc.Iterable[global___LinearBooleanConstraint]
        | None = ...,

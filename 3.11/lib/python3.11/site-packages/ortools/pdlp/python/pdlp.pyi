...
def primal_dual_hybrid_gradient(
    qp: QuadraticProgram, params, initial_solution: PrimalAndDualSolution | None = ...
) -> SolverResult: ...
def qp_from_mpmodel_proto(
    proto_str, relax_integer_variables: bool, include_names: bool = ...
) -> QuadraticProgram: ...
def qp_to_mpmodel_proto(*args, **kwargs): ...
def read_quadratic_program_or_die(
    filename: str, include_names: bool = ...
) -> QuadraticProgram: ...

...
class _OptimalityNormEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _OptimalityNorm.ValueType
    ],
    builtins.type,
):
...
class TerminationCriteria(google.protobuf.message.Message):
    ...
    class SimpleOptimalityCriteria(google.protobuf.message.Message):
        ...
        def HasField(
            ...
            field_name: typing.Literal[
                ...
                b"eps_optimal_absolute",
                "eps_optimal_relative",
                b"eps_optimal_relative",
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    class DetailedOptimalityCriteria(google.protobuf.message.Message):
        ...
        def HasField(
            ...
            field_name: typing.Literal[
                "eps_optimal_dual_residual_absolute",
                b"eps_optimal_dual_residual_absolute",
                "eps_optimal_dual_residual_relative",
                b"eps_optimal_dual_residual_relative",
                "eps_optimal_objective_gap_absolute",
                b"eps_optimal_objective_gap_absolute",
                "eps_optimal_objective_gap_relative",
                b"eps_optimal_objective_gap_relative",
                "eps_optimal_primal_residual_absolute",
                b"eps_optimal_primal_residual_absolute",
    ...
    """
    @property
    def simple_optimality_criteria(
        self,
    ) -> global___TerminationCriteria.SimpleOptimalityCriteria: ...
    @property
    def detailed_optimality_criteria(
        self,
    ) -> global___TerminationCriteria.DetailedOptimalityCriteria: ...
    def __init__(
        self,
        *,
        optimality_norm: global___OptimalityNorm.ValueType | None = ...,
        simple_optimality_criteria: global___TerminationCriteria.SimpleOptimalityCriteria
        | None = ...,
        detailed_optimality_criteria: global___TerminationCriteria.DetailedOptimalityCriteria
        | None = ...,
        eps_optimal_absolute: builtins.float | None = ...,
        eps_optimal_relative: builtins.float | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"detailed_optimality_criteria",
            "eps_dual_infeasible",
            b"eps_dual_infeasible",
            "eps_optimal_absolute",
            b"eps_optimal_absolute",
            "eps_optimal_relative",
            b"eps_optimal_relative",
            "eps_primal_infeasible",
            b"eps_primal_infeasible",
            "iteration_limit",
            b"iteration_limit",
            "kkt_matrix_pass_limit",
            b"kkt_matrix_pass_limit",
            "optimality_criteria",
            b"optimality_criteria",
            "optimality_norm",
            b"optimality_norm",
            "simple_optimality_criteria",
            b"simple_optimality_criteria",
            "time_sec_limit",
            b"time_sec_limit",
        ],
    ) -> builtins.bool: ...
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["optimality_criteria", b"optimality_criteria"]
    ) -> (
        typing.Literal["simple_optimality_criteria", "detailed_optimality_criteria"]
        | None
    ): ...
...
class AdaptiveLinesearchParams(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"step_size_growth_exponent",
            "step_size_reduction_exponent",
            b"step_size_reduction_exponent",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MalitskyPockParams(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"linesearch_contraction_factor",
            "step_size_downscaling_factor",
            b"step_size_downscaling_factor",
            "step_size_interpolation",
            b"step_size_interpolation",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class PrimalDualHybridGradientParams(google.protobuf.message.Message):
    ...
    class _RestartStrategyEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PrimalDualHybridGradientParams._RestartStrategy.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class RestartStrategy(
        _RestartStrategy, metaclass=_RestartStrategyEnumTypeWrapper
    ): ...
    ...
    class _LinesearchRuleEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PrimalDualHybridGradientParams._LinesearchRule.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class PresolveOptions(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing.Literal[
                "glop_parameters", b"glop_parameters", "use_glop", b"use_glop"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    @property
    def presolve_options(
        self,
    ) -> global___PrimalDualHybridGradientParams.PresolveOptions: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        presolve_options: global___PrimalDualHybridGradientParams.PresolveOptions
        | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"adaptive_linesearch_parameters",
            ...
            b"handle_some_primal_gradients_on_finite_bounds_as_residuals",
            "infinite_constraint_bound_threshold",
            b"infinite_constraint_bound_threshold",
            "initial_primal_weight",
            b"initial_primal_weight",
            "initial_step_size_scaling",
            b"initial_step_size_scaling",
            "l2_norm_rescaling",
            b"l2_norm_rescaling",
            "l_inf_ruiz_iterations",
            b"l_inf_ruiz_iterations",
            "linesearch_rule",
            b"linesearch_rule",
            "log_interval_seconds",
            b"log_interval_seconds",
            "major_iteration_frequency",
            b"major_iteration_frequency",
            "malitsky_pock_parameters",
            b"malitsky_pock_parameters",
            "necessary_reduction_for_restart",
            b"necessary_reduction_for_restart",
            "num_shards",
            b"num_shards",
            "num_threads",
            b"num_threads",
            ...
            b"primal_weight_update_smoothing",
            "record_iteration_stats",
            b"record_iteration_stats",
            "restart_strategy",
            b"restart_strategy",
            "sufficient_reduction_for_restart",
            b"sufficient_reduction_for_restart",
            "termination_check_frequency",
            b"termination_check_frequency",
            "termination_criteria",
            b"termination_criteria",
            "use_diagonal_qp_trust_region_solver",
            b"use_diagonal_qp_trust_region_solver",
            "use_feasibility_polishing",
            b"use_feasibility_polishing",
            "verbosity_level",
            b"verbosity_level",
        ],
    ) -> builtins.bool: ...

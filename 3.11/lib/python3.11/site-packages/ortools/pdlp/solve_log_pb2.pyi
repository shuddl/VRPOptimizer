...
class _RestartChoiceEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _RestartChoice.ValueType
    ],
    builtins.type,
):
...
class _PointTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PointType.ValueType],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _TerminationReasonEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _TerminationReason.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class TerminationReason(
    _TerminationReason, metaclass=_TerminationReasonEnumTypeWrapper
): ...
...
class _PolishingPhaseTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _PolishingPhaseType.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class PolishingPhaseType(
    _PolishingPhaseType, metaclass=_PolishingPhaseTypeEnumTypeWrapper
): ...
...
class QuadraticProgramStats(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "combined_bounds_avg",
            b"combined_bounds_avg",
            "combined_bounds_l2_norm",
            b"combined_bounds_l2_norm",
            "combined_bounds_max",
            b"combined_bounds_max",
            "combined_bounds_min",
            b"combined_bounds_min",
            "combined_variable_bounds_avg",
            b"combined_variable_bounds_avg",
            "combined_variable_bounds_l2_norm",
            b"combined_variable_bounds_l2_norm",
            "combined_variable_bounds_max",
            b"combined_variable_bounds_max",
            "combined_variable_bounds_min",
            b"combined_variable_bounds_min",
            "constraint_matrix_abs_avg",
            b"constraint_matrix_abs_avg",
            "constraint_matrix_abs_max",
            b"constraint_matrix_abs_max",
            "constraint_matrix_abs_min",
            b"constraint_matrix_abs_min",
            "constraint_matrix_col_min_l_inf_norm",
            b"constraint_matrix_col_min_l_inf_norm",
            "constraint_matrix_l2_norm",
            b"constraint_matrix_l2_norm",
            "constraint_matrix_num_nonzeros",
            b"constraint_matrix_num_nonzeros",
            "constraint_matrix_row_min_l_inf_norm",
            b"constraint_matrix_row_min_l_inf_norm",
            "num_constraints",
            b"num_constraints",
            "num_variables",
            b"num_variables",
            "objective_matrix_abs_avg",
            b"objective_matrix_abs_avg",
            "objective_matrix_abs_max",
            b"objective_matrix_abs_max",
            "objective_matrix_abs_min",
            b"objective_matrix_abs_min",
            "objective_matrix_l2_norm",
            b"objective_matrix_l2_norm",
            "objective_matrix_num_nonzeros",
            b"objective_matrix_num_nonzeros",
            "objective_vector_abs_avg",
            b"objective_vector_abs_avg",
            "objective_vector_abs_max",
            b"objective_vector_abs_max",
            "objective_vector_abs_min",
            b"objective_vector_abs_min",
            "objective_vector_l2_norm",
            b"objective_vector_l2_norm",
            "variable_bound_gaps_avg",
            b"variable_bound_gaps_avg",
            "variable_bound_gaps_l2_norm",
            b"variable_bound_gaps_l2_norm",
            "variable_bound_gaps_max",
            b"variable_bound_gaps_max",
            "variable_bound_gaps_min",
            b"variable_bound_gaps_min",
            "variable_bound_gaps_num_finite",
            b"variable_bound_gaps_num_finite",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ConvergenceInformation(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"l2_dual_variable",
            "l2_primal_residual",
            b"l2_primal_residual",
            "l2_primal_variable",
            b"l2_primal_variable",
            "l_inf_componentwise_dual_residual",
            b"l_inf_componentwise_dual_residual",
            "l_inf_componentwise_primal_residual",
            b"l_inf_componentwise_primal_residual",
            "l_inf_dual_residual",
            b"l_inf_dual_residual",
            "l_inf_dual_variable",
            b"l_inf_dual_variable",
            "l_inf_primal_residual",
            b"l_inf_primal_residual",
            "l_inf_primal_variable",
            b"l_inf_primal_variable",
            "primal_objective",
            b"primal_objective",
        ],
    ) -> builtins.bool: ...
...
class PointMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        random_primal_projections: collections.abc.Iterable[builtins.float]
        | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"active_dual_variable_change",
            "active_dual_variable_count",
            b"active_dual_variable_count",
            "active_primal_variable_change",
            b"active_primal_variable_change",
            "active_primal_variable_count",
            b"active_primal_variable_count",
            "point_type",
            b"point_type",
        ],
    ) -> builtins.bool: ...
...
class IterationStats(google.protobuf.message.Message):
    ...
    *after* the iteration. Therefore stats from iteration 0 are the stats at
    ...
    """
    @property
    def convergence_information(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ConvergenceInformation
    ]:
        ...
        """
    @property
    def infeasibility_information(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___InfeasibilityInformation
    ]:
        """A set of statistics measuring how close a point is to establishing primal
    ...
    def __init__(
        ...
        *,
        ...
        convergence_information: collections.abc.Iterable[
            global___ConvergenceInformation
        ]
        | None = ...,
        infeasibility_information: collections.abc.Iterable[
            global___InfeasibilityInformation
        ]
        | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"cumulative_kkt_matrix_passes",
            "cumulative_rejected_steps",
            b"cumulative_rejected_steps",
            "cumulative_time_sec",
            b"cumulative_time_sec",
            "iteration_number",
            b"iteration_number",
            "primal_weight",
            b"primal_weight",
...
class FeasibilityPolishingDetails(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"main_iteration_count",
            "params",
            b"params",
            "polishing_phase_type",
            b"polishing_phase_type",
            "solution_stats",
            b"solution_stats",
            "solution_type",
            b"solution_type",
...
class SolveLog(google.protobuf.message.Message):
    ...
    @property
    def feasibility_polishing_details(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___FeasibilityPolishingDetails
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        feasibility_polishing_details: collections.abc.Iterable[
            global___FeasibilityPolishingDetails
        ]
        | None = ...,
    ) -> None: ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"original_problem_stats",
            "params",
            b"params",
            "preprocessed_problem_stats",
            b"preprocessed_problem_stats",
            "preprocessing_time_sec",
            b"preprocessing_time_sec",
            "solution_stats",
            b"solution_stats",
            "solution_type",
            b"solution_type",
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"feasibility_polishing_details",
            "instance_name",
            b"instance_name",
            "iteration_count",
            b"iteration_count",

...
class _VectorBinPackingSolveStatusEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _VectorBinPackingSolveStatus.ValueType
    ],
    builtins.type,
):
...
class VectorBinPackingSolveStatus(
    _VectorBinPackingSolveStatus, metaclass=_VectorBinPackingSolveStatusEnumTypeWrapper
):
    """Solve status"""
...
class Item(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "max_number_of_copies_per_bin",
            b"max_number_of_copies_per_bin",
            "name",
            b"name",
            "num_copies",
            b"num_copies",
            "num_optional_copies",
            b"num_optional_copies",
            "penalty_per_missing_copy",
            b"penalty_per_missing_copy",
            "resource_usage",
            b"resource_usage",
        ],
    ) -> None: ...
...
class VectorBinPackingProblem(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_cost_per_bin", b"_cost_per_bin", "cost_per_bin", b"cost_per_bin"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_cost_per_bin", b"_cost_per_bin"]
    ) -> typing.Literal["cost_per_bin"] | None: ...
...
class VectorBinPackingOneBinInSolution(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "item_copies", b"item_copies", "item_indices", b"item_indices"
        ],
    ) -> None: ...
...
class VectorBinPackingSolution(google.protobuf.message.Message):
    ...
    def bins(
        ...
        global___VectorBinPackingOneBinInSolution
    ]:
        """Filled bins."""
    def __init__(
        self,
        *,
        solver_info: builtins.str = ...,
        bins: collections.abc.Iterable[global___VectorBinPackingOneBinInSolution]
        | None = ...,
        status: global___VectorBinPackingSolveStatus.ValueType = ...,
        objective_value: builtins.float = ...,
        solve_time_in_seconds: builtins.float = ...,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "arc_flow_time_in_seconds",
            b"arc_flow_time_in_seconds",
            "bins",
            b"bins",
            "objective_value",
            b"objective_value",
            "solve_time_in_seconds",
            b"solve_time_in_seconds",
            "solver_info",
            b"solver_info",
            "status",
            b"status",

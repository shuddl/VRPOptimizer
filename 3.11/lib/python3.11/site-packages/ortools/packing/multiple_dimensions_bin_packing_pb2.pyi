...
class MultipleDimensionsBinPackingShape(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["dimensions", b"dimensions"]
    ) -> None: ...
...
class MultipleDimensionsBinPackingItem(google.protobuf.message.Message):
    ...
    def shapes(
        ...
        global___MultipleDimensionsBinPackingShape
    ]:
        """All available shapes of the item."""
    def __init__(
        self,
        *,
        shapes: collections.abc.Iterable[global___MultipleDimensionsBinPackingShape]
        | None = ...,
        value: builtins.int = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["shapes", b"shapes", "value", b"value"]
    ) -> None: ...
...
class MultipleDimensionsBinPackingProblem(google.protobuf.message.Message):
    ...
    def items(
        ...
        global___MultipleDimensionsBinPackingItem
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        items: collections.abc.Iterable[global___MultipleDimensionsBinPackingItem]
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["box_shape", b"box_shape"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["box_shape", b"box_shape", "items", b"items"]
    ) -> None: ...

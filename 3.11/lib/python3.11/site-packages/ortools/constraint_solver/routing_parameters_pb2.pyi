...
class RoutingSearchParameters(google.protobuf.message.Message):
    ...
    class _PairInsertionStrategyEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            RoutingSearchParameters._PairInsertionStrategy.ValueType
        ],
        builtins.type,
    ):
    ...
    class PairInsertionStrategy(
        _PairInsertionStrategy, metaclass=_PairInsertionStrategyEnumTypeWrapper
    ):
    ...
    class _SchedulingSolverEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
    ...
    class SchedulingSolver(
        _SchedulingSolver, metaclass=_SchedulingSolverEnumTypeWrapper
    ):
    ...
    class LocalSearchNeighborhoodOperators(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                ...
                b"use_cross",
                "use_cross_exchange",
                b"use_cross_exchange",
                "use_exchange",
                b"use_exchange",
                "use_exchange_pair",
                b"use_exchange_pair",
                "use_exchange_subtrip",
                b"use_exchange_subtrip",
                "use_extended_swap_active",
                b"use_extended_swap_active",
                "use_full_path_lns",
                b"use_full_path_lns",
                "use_global_cheapest_insertion_close_nodes_lns",
                b"use_global_cheapest_insertion_close_nodes_lns",
                ...
                b"use_global_cheapest_insertion_path_lns",
                "use_inactive_lns",
                b"use_inactive_lns",
                "use_light_relocate_pair",
                b"use_light_relocate_pair",
                "use_lin_kernighan",
                b"use_lin_kernighan",
                ...
                b"use_local_cheapest_insertion_expensive_chain_lns",
                "use_local_cheapest_insertion_path_lns",
                b"use_local_cheapest_insertion_path_lns",
                "use_make_active",
                b"use_make_active",
                ...
                b"use_relocate_and_make_active",
                "use_relocate_expensive_chain",
                b"use_relocate_expensive_chain",
                "use_relocate_neighbors",
                b"use_relocate_neighbors",
                "use_relocate_pair",
                b"use_relocate_pair",
                ...
                b"use_relocate_subtrip",
                "use_shortest_path_swap_active",
                b"use_shortest_path_swap_active",
                "use_swap_active",
                b"use_swap_active",
                "use_tsp_lns",
                b"use_tsp_lns",
    ...
    class ImprovementSearchLimitParameters(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                ...
                b"improvement_rate_coefficient",
    ...
    """
    @property
    def local_search_operators(
        self,
    ) -> global___RoutingSearchParameters.LocalSearchNeighborhoodOperators: ...
    @property
    ...
    def lns_time_limit(self) -> google.protobuf.duration_pb2.Duration:
        ...
        """
    @property
    def improvement_limit_parameters(
        self,
    ) -> global___RoutingSearchParameters.ImprovementSearchLimitParameters:
        """The improvement search limit is added to the solver if the following
        parameters are set.
        """
    @property
    def iterated_local_search_parameters(
        self,
    ) -> ortools.constraint_solver.routing_ils_pb2.IteratedLocalSearchParameters:
    ...
    def __init__(
        ...
        *,
        ...
        christofides_use_minimum_matching: builtins.bool = ...,
        first_solution_optimization_period: builtins.int = ...,
        local_search_operators: global___RoutingSearchParameters.LocalSearchNeighborhoodOperators
        | None = ...,
        ls_operator_neighbors_ratio: builtins.float = ...,
        ls_operator_min_neighbors: builtins.int = ...,
        use_multi_armed_bandit_concatenate_operators: builtins.bool = ...,
        ...
        secondary_ls_time_limit_ratio: builtins.float = ...,
        improvement_limit_parameters: global___RoutingSearchParameters.ImprovementSearchLimitParameters
        | None = ...,
        use_full_propagation: builtins.bool = ...,
        log_search: builtins.bool = ...,
        log_cost_scaling_factor: builtins.float = ...,
        ...
        log_tag: builtins.str = ...,
        use_iterated_local_search: builtins.bool = ...,
        iterated_local_search_parameters: ortools.constraint_solver.routing_ils_pb2.IteratedLocalSearchParameters
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_disable_scheduling_beware_this_may_degrade_performance",
            b"_disable_scheduling_beware_this_may_degrade_performance",
            "disable_scheduling_beware_this_may_degrade_performance",
            b"disable_scheduling_beware_this_may_degrade_performance",
            "improvement_limit_parameters",
            b"improvement_limit_parameters",
            "iterated_local_search_parameters",
            b"iterated_local_search_parameters",
            "lns_time_limit",
            b"lns_time_limit",
            "local_search_operators",
            b"local_search_operators",
            "sat_parameters",
            b"sat_parameters",
            "time_limit",
            b"time_limit",
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"cheapest_insertion_add_unperformed_entries",
            "cheapest_insertion_farthest_seeds_ratio",
            b"cheapest_insertion_farthest_seeds_ratio",
            "cheapest_insertion_first_solution_min_neighbors",
            b"cheapest_insertion_first_solution_min_neighbors",
            "cheapest_insertion_first_solution_neighbors_ratio",
            b"cheapest_insertion_first_solution_neighbors_ratio",
            "cheapest_insertion_first_solution_use_neighbors_ratio_for_initialization",
            b"cheapest_insertion_first_solution_use_neighbors_ratio_for_initialization",
            "cheapest_insertion_ls_operator_min_neighbors",
            b"cheapest_insertion_ls_operator_min_neighbors",
            "cheapest_insertion_ls_operator_neighbors_ratio",
            b"cheapest_insertion_ls_operator_neighbors_ratio",
            "christofides_use_minimum_matching",
            b"christofides_use_minimum_matching",
            "continuous_scheduling_solver",
            b"continuous_scheduling_solver",
            "disable_scheduling_beware_this_may_degrade_performance",
            b"disable_scheduling_beware_this_may_degrade_performance",
            "fallback_to_cp_sat_size_threshold",
            b"fallback_to_cp_sat_size_threshold",
            "first_solution_optimization_period",
            b"first_solution_optimization_period",
            "first_solution_strategy",
            b"first_solution_strategy",
            "guided_local_search_lambda_coefficient",
            b"guided_local_search_lambda_coefficient",
            "guided_local_search_reset_penalties_on_new_best_solution",
            b"guided_local_search_reset_penalties_on_new_best_solution",
            "heuristic_close_nodes_lns_num_nodes",
            b"heuristic_close_nodes_lns_num_nodes",
            "heuristic_expensive_chain_lns_num_arcs_to_consider",
            b"heuristic_expensive_chain_lns_num_arcs_to_consider",
            "improvement_limit_parameters",
            b"improvement_limit_parameters",
            "iterated_local_search_parameters",
            b"iterated_local_search_parameters",
            ...
            b"local_cheapest_cost_insertion_pickup_delivery_strategy",
            "local_cheapest_insertion_pickup_delivery_strategy",
            b"local_cheapest_insertion_pickup_delivery_strategy",
            "local_search_metaheuristic",
            b"local_search_metaheuristic",
            "local_search_operators",
            b"local_search_operators",
            "log_cost_offset",
            b"log_cost_offset",
            "log_cost_scaling_factor",
            b"log_cost_scaling_factor",
            "log_search",
            b"log_search",
            "log_tag",
            b"log_tag",
            "ls_operator_min_neighbors",
            b"ls_operator_min_neighbors",
            "ls_operator_neighbors_ratio",
            b"ls_operator_neighbors_ratio",
            "mixed_integer_scheduling_solver",
            b"mixed_integer_scheduling_solver",
            "multi_armed_bandit_compound_operator_exploration_coefficient",
            b"multi_armed_bandit_compound_operator_exploration_coefficient",
            "multi_armed_bandit_compound_operator_memory_coefficient",
            b"multi_armed_bandit_compound_operator_memory_coefficient",
            "number_of_solutions_to_collect",
            b"number_of_solutions_to_collect",
            "optimization_step",
            b"optimization_step",
            "relocate_expensive_chain_num_arcs_to_consider",
            b"relocate_expensive_chain_num_arcs_to_consider",
            "report_intermediate_cp_sat_solutions",
            b"report_intermediate_cp_sat_solutions",
            "sat_parameters",
            b"sat_parameters",
            "savings_add_reverse_arcs",
            b"savings_add_reverse_arcs",
            "savings_arc_coefficient",
            b"savings_arc_coefficient",
            "savings_max_memory_usage_bytes",
            b"savings_max_memory_usage_bytes",
            "savings_neighbors_ratio",
            b"savings_neighbors_ratio",
            "savings_parallel_routes",
            b"savings_parallel_routes",
            ...
            b"use_depth_first_search",
            "use_full_propagation",
            b"use_full_propagation",
            "use_generalized_cp_sat",
            b"use_generalized_cp_sat",
            "use_iterated_local_search",
            b"use_iterated_local_search",
            "use_multi_armed_bandit_concatenate_operators",
            b"use_multi_armed_bandit_concatenate_operators",
    ...
    def WhichOneof(
        ...
        typing.Literal["disable_scheduling_beware_this_may_degrade_performance"] | None
    ): ...
...
class RoutingModelParameters(google.protobuf.message.Message):
    ...
    def solver_parameters(
        self,
    ) -> ortools.constraint_solver.solver_parameters_pb2.ConstraintSolverParameters:
        """Parameters to use in the underlying constraint solver."""
    def __init__(
        self,
        *,
        solver_parameters: ortools.constraint_solver.solver_parameters_pb2.ConstraintSolverParameters
        | None = ...,
        reduce_vehicle_cost_model: builtins.bool = ...,
        max_callback_cache_size: builtins.int = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["solver_parameters", b"solver_parameters"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "max_callback_cache_size",
            b"max_callback_cache_size",
            "reduce_vehicle_cost_model",
            b"reduce_vehicle_cost_model",
            "solver_parameters",
            b"solver_parameters",
        ],
    ) -> None: ...

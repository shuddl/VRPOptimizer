...
class Solver:
    ...
    def FixedDurationStartSyncedOnEndIntervalVar(
        self, interval_var, duration, offset
    ): ...
    def FixedDurationEndSyncedOnStartIntervalVar(
        self, interval_var, duration, offset
    ): ...
...
class RoutingModel:
    ...
    def AddAtSolutionCallback(
        self, callback, track_unchecked_neighbors: bool = False
    ): ...
    ...
    def SolveWithParameters(
        self, search_parameters, solutions: Incomplete | None = None
    ): ...
    def SolveFromAssignmentWithParameters(
        self, assignment, search_parameters, solutions: Incomplete | None = None
    ): ...
    def FastSolveFromAssignmentWithParameters(
        ...
        touched: Incomplete | None = None,
    ): ...
    def SolveFromAssignmentsWithParameters(
        self, assignments, search_parameters, solutions: Incomplete | None = None
    ): ...
    ...
    def PackCumulsOfOptimizerDimensionsFromAssignment(
        ...
        original_assignment,
        duration_limit,
        time_limit_was_reached: Incomplete | None = None,
    ): ...

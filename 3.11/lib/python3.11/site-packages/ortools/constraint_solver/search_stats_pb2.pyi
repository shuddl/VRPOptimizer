...
class LocalSearchStatistics(google.protobuf.message.Message):
    ...
    class FirstSolutionStatistics(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                "duration_seconds", b"duration_seconds", "strategy", b"strategy"
            ],
        ) -> None: ...
    ...
    class LocalSearchOperatorStatistics(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                ...
                b"local_search_operator",
                "num_accepted_neighbors",
                b"num_accepted_neighbors",
                "num_filtered_neighbors",
                b"num_filtered_neighbors",
                "num_neighbors",
                b"num_neighbors",
            ],
        ) -> None: ...
    ...
    class LocalSearchFilterStatistics(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                ...
                b"duration_seconds",
                "local_search_filter",
                b"local_search_filter",
                "num_calls",
                b"num_calls",
                "num_rejects",
                b"num_rejects",
                "num_rejects_per_second",
                b"num_rejects_per_second",
            ],
        ) -> None: ...
    ...
    @property
    def first_solution_statistics(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___LocalSearchStatistics.FirstSolutionStatistics
    ]:
        """Statistics for each first solution called during the search."""
    @property
    def local_search_operator_statistics(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___LocalSearchStatistics.LocalSearchOperatorStatistics
    ]:
        """Statistics for each operator called during the search."""
    @property
    def local_search_filter_statistics(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___LocalSearchStatistics.LocalSearchFilterStatistics
    ]:
        """Statistics for each filter called during the search."""
    def __init__(
        self,
        *,
        first_solution_statistics: collections.abc.Iterable[
            global___LocalSearchStatistics.FirstSolutionStatistics
        ]
        | None = ...,
        local_search_operator_statistics: collections.abc.Iterable[
            global___LocalSearchStatistics.LocalSearchOperatorStatistics
        ]
        | None = ...,
        total_num_neighbors: builtins.int = ...,
        total_num_filtered_neighbors: builtins.int = ...,
        total_num_accepted_neighbors: builtins.int = ...,
        local_search_filter_statistics: collections.abc.Iterable[
            global___LocalSearchStatistics.LocalSearchFilterStatistics
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"first_solution_statistics",
            "local_search_filter_statistics",
            b"local_search_filter_statistics",
            "local_search_operator_statistics",
            b"local_search_operator_statistics",
            "total_num_accepted_neighbors",
            b"total_num_accepted_neighbors",
            "total_num_filtered_neighbors",
            b"total_num_filtered_neighbors",
            "total_num_neighbors",
...
class SearchStatistics(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"constraint_solver_statistics",
            "local_search_statistics",
            b"local_search_statistics",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,

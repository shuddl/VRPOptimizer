...
class IntVarAssignment(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "active", b"active", "max", b"max", "min", b"min", "var_id", b"var_id"
        ],
    ) -> None: ...
...
class WorkerInfo(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["bns", b"bns", "worker_id", b"worker_id"]
    ) -> None: ...
...
class AssignmentProto(google.protobuf.message.Message):
    ...
    @property
    def int_var_assignment(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___IntVarAssignment
    ]: ...
    @property
    def interval_var_assignment(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___IntervalVarAssignment
    ]: ...
    @property
    def sequence_var_assignment(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___SequenceVarAssignment
    ]: ...
    @property
    def objective(
        self,
    ...
    def __init__(
        self,
        *,
        int_var_assignment: collections.abc.Iterable[global___IntVarAssignment]
        | None = ...,
        interval_var_assignment: collections.abc.Iterable[
            global___IntervalVarAssignment
        ]
        | None = ...,
        sequence_var_assignment: collections.abc.Iterable[
            global___SequenceVarAssignment
        ]
        | None = ...,
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "int_var_assignment",
            b"int_var_assignment",
            "interval_var_assignment",
            b"interval_var_assignment",
            "is_valid",
            b"is_valid",
            "objective",
            b"objective",
            "sequence_var_assignment",
            b"sequence_var_assignment",
            "worker_info",
            b"worker_info",
        ],
    ) -> None: ...

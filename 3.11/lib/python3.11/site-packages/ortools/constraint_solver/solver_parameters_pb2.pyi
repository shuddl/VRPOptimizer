...
class ConstraintSolverParameters(google.protobuf.message.Message):
    ...
    class _TrailCompressionEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ConstraintSolverParameters._TrailCompression.ValueType
        ],
        builtins.type,
    ):
    ...
    class TrailCompression(
        _TrailCompression, metaclass=_TrailCompressionEnumTypeWrapper
    ):
        """
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"check_solution_period",
            "compress_trail",
            b"compress_trail",
            "diffn_use_cumulative",
            b"diffn_use_cumulative",
            "disable_solve",
            b"disable_solve",
            "max_edge_finder_size",
            b"max_edge_finder_size",
            "name_all_variables",
            b"name_all_variables",
            "name_cast_variables",
            b"name_cast_variables",
            "print_added_constraints",
            b"print_added_constraints",
            "print_local_search_profile",
            b"print_local_search_profile",
            "print_model",
            b"print_model",
            "print_model_stats",
            b"print_model_stats",
            ...
            b"profile_local_search",
            "profile_propagation",
            b"profile_propagation",
            "skip_locally_optimal_paths",
            b"skip_locally_optimal_paths",
            "store_names",
            b"store_names",
            "trace_propagation",
            b"trace_propagation",
            ...
            b"use_all_possible_disjunctions",
            "use_cumulative_edge_finder",
            b"use_cumulative_edge_finder",
            "use_cumulative_time_table",
            b"use_cumulative_time_table",
            "use_cumulative_time_table_sync",
            b"use_cumulative_time_table_sync",
            "use_element_rmq",
            b"use_element_rmq",
            "use_sequence_high_demand_tasks",
            b"use_sequence_high_demand_tasks",
            "use_small_table",
            b"use_small_table",
        ],
    ) -> None: ...

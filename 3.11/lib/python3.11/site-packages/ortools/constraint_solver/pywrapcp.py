...
class DefaultPhaseParameters(object):
    ...
    CHOOSE_MAX_AVERAGE_IMPACT = (
        _pywrapcp.DefaultPhaseParameters_CHOOSE_MAX_AVERAGE_IMPACT
    )
    ...
    var_selection_schema = property(
        _pywrapcp.DefaultPhaseParameters_var_selection_schema_get,
    ...
    value_selection_schema = property(
        _pywrapcp.DefaultPhaseParameters_value_selection_schema_get,
        _pywrapcp.DefaultPhaseParameters_value_selection_schema_set,
        doc=r""" This parameter describes which value to select for a given var.""",
    )
    initialization_splits = property(
        _pywrapcp.DefaultPhaseParameters_initialization_splits_get,
        _pywrapcp.DefaultPhaseParameters_initialization_splits_set,
        doc=r"""
    Maximum number of intervals that the initialization of impacts will scan
    per variable.
    """,
    )
    run_all_heuristics = property(
        _pywrapcp.DefaultPhaseParameters_run_all_heuristics_get,
        _pywrapcp.DefaultPhaseParameters_run_all_heuristics_set,
        doc=r"""
    ...
    heuristic_period = property(
        _pywrapcp.DefaultPhaseParameters_heuristic_period_get,
        _pywrapcp.DefaultPhaseParameters_heuristic_period_set,
        doc=r"""
    ...
    heuristic_num_failures_limit = property(
        _pywrapcp.DefaultPhaseParameters_heuristic_num_failures_limit_get,
        _pywrapcp.DefaultPhaseParameters_heuristic_num_failures_limit_set,
        doc=r""" The failure limit for each heuristic that we run.""",
    )
    persistent_impact = property(
        _pywrapcp.DefaultPhaseParameters_persistent_impact_get,
        _pywrapcp.DefaultPhaseParameters_persistent_impact_set,
        doc=r"""
    ...
    random_seed = property(
        _pywrapcp.DefaultPhaseParameters_random_seed_get,
        _pywrapcp.DefaultPhaseParameters_random_seed_set,
        doc=r""" Seed used to initialize the random part in some heuristics.""",
    )
    display_level = property(
        _pywrapcp.DefaultPhaseParameters_display_level_get,
        _pywrapcp.DefaultPhaseParameters_display_level_set,
        doc=r"""
    ...
    decision_builder = property(
        _pywrapcp.DefaultPhaseParameters_decision_builder_get,
        _pywrapcp.DefaultPhaseParameters_decision_builder_set,
        doc=r""" When defined, this overrides the default impact based decision builder.""",
    )

    def __init__(self):
        _pywrapcp.DefaultPhaseParameters_swiginit(
            self, _pywrapcp.new_DefaultPhaseParameters()
        )
...
class Solver(object):
    ...
    def ConvexPiecewiseExpr(self, expr, early_cost, early_date, late_date, late_cost):
        ...
        return _pywrapcp.Solver_ConvexPiecewiseExpr(
            self, expr, early_cost, early_date, late_date, late_cost
        )
    ...
    def ConditionalExpression(self, condition, expr, unperformed_value):
        ...
        return _pywrapcp.Solver_ConditionalExpression(
            self, condition, expr, unperformed_value
        )
    ...
    def NullIntersectExcept(self, first_vars, second_vars, escape_value):
        ...
        intersect with the set of values in the second vector.
        """
        return _pywrapcp.Solver_NullIntersectExcept(
            self, first_vars, second_vars, escape_value
        )
    ...
    def IntervalVar(
        ...
        duration, and end.
        """
        return _pywrapcp.Solver_IntervalVar(
            self,
            start_min,
            start_max,
            duration_min,
    ...
    def FixedDurationStartSyncedOnStartIntervalVar(
        ...
        """
        return _pywrapcp.Solver_FixedDurationStartSyncedOnStartIntervalVar(
            self, interval_var, duration, offset
        )
    ...
    def FixedDurationStartSyncedOnEndIntervalVar(self, interval_var, duration, offset):
        ...
        status of the given interval variable.
        """
        return _pywrapcp.Solver_FixedDurationStartSyncedOnEndIntervalVar(
            self, interval_var, duration, offset
        )
    ...
    def FixedDurationEndSyncedOnStartIntervalVar(self, interval_var, duration, offset):
        ...
        status of the given interval variable.
        """
        return _pywrapcp.Solver_FixedDurationEndSyncedOnStartIntervalVar(
            self, interval_var, duration, offset
        )
    ...
    def FixedDurationEndSyncedOnEndIntervalVar(self, interval_var, duration, offset):
        ...
        status of the given interval variable.
        """
        return _pywrapcp.Solver_FixedDurationEndSyncedOnEndIntervalVar(
            self, interval_var, duration, offset
        )
    ...
    def TabuSearch(
        self, maximize, objective, step, vars, keep_tenure, forbid_tenure, tabu_factor
    ):
        r"""
        ...
        """
        return _pywrapcp.Solver_TabuSearch(
            self,
            maximize,
            objective,
            step,
    ...
    def SimulatedAnnealing(self, maximize, v, step, initial_temperature):
        ...
        return _pywrapcp.Solver_SimulatedAnnealing(
            self, maximize, v, step, initial_temperature
        )
    ...
    def SplitVariableDomain(self, var, val, start_with_lower_half):
        return _pywrapcp.Solver_SplitVariableDomain(
            self, var, val, start_with_lower_half
        )
    ...
    def DecisionBuilderFromAssignment(self, assignment, db, vars):
        ...
        """
        return _pywrapcp.Solver_DecisionBuilderFromAssignment(
            self, assignment, db, vars
        )
    ...
    def VarStrValEvalTieBreakPhase(self, vars, var_str, val_eval, tie_breaker):
        return _pywrapcp.Solver_VarStrValEvalTieBreakPhase(
            self, vars, var_str, val_eval, tie_breaker
        )

    def VarEvalValEvalTieBreakPhase(self, vars, var_eval, val_eval, tie_breaker):
        return _pywrapcp.Solver_VarEvalValEvalTieBreakPhase(
            self, vars, var_eval, val_eval, tie_breaker
        )
    ...
    def EvalEvalStrTieBreakPhase(self, vars, evaluator, tie_breaker, str):
        return _pywrapcp.Solver_EvalEvalStrTieBreakPhase(
            self, vars, evaluator, tie_breaker, str
        )
...
class BaseObject(object):
    ...
    def __init__(self):
        if self.__class__ == BaseObject:
            ...
            _self = self
        _pywrapcp.BaseObject_swiginit(
            self,
            _pywrapcp.new_BaseObject(
                _self,
            ),
        )
...
class PropagationBaseObject(BaseObject):
    ...
    def __init__(self, s):
        if self.__class__ == PropagationBaseObject:
            ...
            _self = self
        _pywrapcp.PropagationBaseObject_swiginit(
            self, _pywrapcp.new_PropagationBaseObject(_self, s)
        )
...
class Decision(BaseObject):
    ...
    def __init__(self):
        if self.__class__ == Decision:
            ...
            _self = self
        _pywrapcp.Decision_swiginit(
            self,
            _pywrapcp.new_Decision(
                _self,
            ),
        )
...
class DecisionBuilder(BaseObject):
    ...
    def __init__(self):
        if self.__class__ == DecisionBuilder:
            ...
            _self = self
        _pywrapcp.DecisionBuilder_swiginit(
            self,
            _pywrapcp.new_DecisionBuilder(
                _self,
            ),
        )
...
class SequenceVarElement(AssignmentElement):
    ...
    def SetSequence(self, forward_sequence, backward_sequence, unperformed):
        return _pywrapcp.SequenceVarElement_SetSequence(
            self, forward_sequence, backward_sequence, unperformed
        )
...
class Assignment(PropagationBaseObject):
    ...
    def SetSequence(self, var, forward_sequence, backward_sequence, unperformed):
        return _pywrapcp.Assignment_SetSequence(
            self, var, forward_sequence, backward_sequence, unperformed
        )
...
class Pack(Constraint):
    ...
    def AddSumVariableWeightsLessOrEqualConstantDimension(self, usage, capacity):
        ...
        constraint.
        """
        return _pywrapcp.Pack_AddSumVariableWeightsLessOrEqualConstantDimension(
            self, usage, capacity
        )
...
class DisjunctiveConstraint(Constraint):
    ...
    def TransitionTime(self, before_index, after_index):
        return _pywrapcp.DisjunctiveConstraint_TransitionTime(
            self, before_index, after_index
        )
...
class NumericalRevInteger(RevInteger):
    ...
    def __init__(self, val):
        _pywrapcp.NumericalRevInteger_swiginit(
            self, _pywrapcp.new_NumericalRevInteger(val)
        )
...
class IntVarLocalSearchOperator(LocalSearchOperator):
    ...
    def __init__(self, vars, keep_inverse_values=False):
        if self.__class__ == IntVarLocalSearchOperator:
            ...
            _self = self
        _pywrapcp.IntVarLocalSearchOperator_swiginit(
            self,
            _pywrapcp.new_IntVarLocalSearchOperator(_self, vars, keep_inverse_values),
        )
...
class LocalSearchFilter(BaseObject):
    ...
    def Accept(self, delta, deltadelta, objective_min, objective_max):
        ...
        """
        return _pywrapcp.LocalSearchFilter_Accept(
...
class LocalSearchFilterManager(BaseObject):
    ...
    def __init__(self, *args):
        _pywrapcp.LocalSearchFilterManager_swiginit(
            self, _pywrapcp.new_LocalSearchFilterManager(*args)
        )
    ...
    def Accept(self, monitor, delta, deltadelta, objective_min, objective_max):
        ...
        """
        return _pywrapcp.LocalSearchFilterManager_Accept(
            self, monitor, delta, deltadelta, objective_min, objective_max
        )
...
class IntVarLocalSearchFilter(LocalSearchFilter):
    ...
    def __init__(self, vars):
        if self.__class__ == IntVarLocalSearchFilter:
            ...
            _self = self
        _pywrapcp.IntVarLocalSearchFilter_swiginit(
            self, _pywrapcp.new_IntVarLocalSearchFilter(_self, vars)
        )
...
class RoutingIndexManager(object):
    ...
    def __init__(self, *args):
        _pywrapcp.RoutingIndexManager_swiginit(
            self, _pywrapcp.new_RoutingIndexManager(*args)
        )
...
class FirstSolutionStrategy(object):
    ...
    def __init__(self):
        _pywrapcp.FirstSolutionStrategy_swiginit(
            self, _pywrapcp.new_FirstSolutionStrategy()
        )
...
class LocalSearchMetaheuristic(object):
    ...
    def __init__(self):
        _pywrapcp.LocalSearchMetaheuristic_swiginit(
            self, _pywrapcp.new_LocalSearchMetaheuristic()
        )
...
class RoutingModel(object):
    ...
    kTransitEvaluatorSignPositiveOrZero = (
        _pywrapcp.RoutingModel_kTransitEvaluatorSignPositiveOrZero
    )
    kTransitEvaluatorSignNegativeOrZero = (
        _pywrapcp.RoutingModel_kTransitEvaluatorSignNegativeOrZero
    )
    ...
    def AddDimension(
        self, evaluator_index, slack_max, capacity, fix_start_cumul_to_zero, name
    ):
        r"""
        Model creation
        ...
        """
        return _pywrapcp.RoutingModel_AddDimension(
            self, evaluator_index, slack_max, capacity, fix_start_cumul_to_zero, name
        )

    def AddDimensionWithVehicleTransits(
        self, evaluator_indices, slack_max, capacity, fix_start_cumul_to_zero, name
    ):
    ...
    def AddDimensionWithVehicleCapacity(
        ...
        return _pywrapcp.RoutingModel_AddDimensionWithVehicleCapacity(
            self,
            evaluator_index,
            slack_max,
            vehicle_capacities,
    ...
    def AddDimensionWithVehicleTransitAndCapacity(
        ...
        return _pywrapcp.RoutingModel_AddDimensionWithVehicleTransitAndCapacity(
            self,
            evaluator_indices,
            slack_max,
            vehicle_capacities,
    ...
    def AddConstantDimensionWithSlack(
    ...
    def AddConstantDimension(self, value, capacity, fix_start_cumul_to_zero, name):
        return _pywrapcp.RoutingModel_AddConstantDimension(
            self, value, capacity, fix_start_cumul_to_zero, name
        )
    ...
    def AddVectorDimension(self, values, capacity, fix_start_cumul_to_zero, name):
        ...
        (and doesn't create the new dimension but still register a new callback).
        """
        return _pywrapcp.RoutingModel_AddVectorDimension(
            self, values, capacity, fix_start_cumul_to_zero, name
        )
    ...
    def AddMatrixDimension(self, values, capacity, fix_start_cumul_to_zero, name):
        ...
        (and doesn't create the new dimension but still register a new callback).
        """
        return _pywrapcp.RoutingModel_AddMatrixDimension(
            self, values, capacity, fix_start_cumul_to_zero, name
        )
    ...
    def SetPrimaryConstrainedDimension(self, dimension_name):
        ...
        """
        return _pywrapcp.RoutingModel_SetPrimaryConstrainedDimension(
            self, dimension_name
        )
    ...
    def AddPickupAndDeliverySets(self, pickup_disjunction, delivery_disjunction):
        ...
        """
        return _pywrapcp.RoutingModel_AddPickupAndDeliverySets(
            self, pickup_disjunction, delivery_disjunction
        )
    ...
    def SetPickupAndDeliveryPolicyOfAllVehicles(self, policy):
        ...
        """
        return _pywrapcp.RoutingModel_SetPickupAndDeliveryPolicyOfAllVehicles(
            self, policy
        )

    def SetPickupAndDeliveryPolicyOfVehicle(self, policy, vehicle):
        return _pywrapcp.RoutingModel_SetPickupAndDeliveryPolicyOfVehicle(
            self, policy, vehicle
        )
    ...
    ADDED_TYPE_REMOVED_FROM_VEHICLE = (
        _pywrapcp.RoutingModel_ADDED_TYPE_REMOVED_FROM_VEHICLE
    )
    r"""
    ...
    TYPE_SIMULTANEOUSLY_ADDED_AND_REMOVED = (
        _pywrapcp.RoutingModel_TYPE_SIMULTANEOUSLY_ADDED_AND_REMOVED
    )
    r"""
    ...
    def AddSameVehicleRequiredTypeAlternatives(
        ...
        route.
        """
        return _pywrapcp.RoutingModel_AddSameVehicleRequiredTypeAlternatives(
            self, dependent_type, required_type_alternatives
        )

    def AddRequiredTypeAlternativesWhenAddingType(
        self, dependent_type, required_type_alternatives
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_AddRequiredTypeAlternativesWhenAddingType(
            self, dependent_type, required_type_alternatives
        )

    def AddRequiredTypeAlternativesWhenRemovingType(
        self, dependent_type, required_type_alternatives
    ):
        r"""
        ...
        visited.
        """
        return _pywrapcp.RoutingModel_AddRequiredTypeAlternativesWhenRemovingType(
            self, dependent_type, required_type_alternatives
        )
    ...
    def GetSameVehicleRequiredTypeAlternativesOfType(self, type):
        ...
        type.
        """
        return _pywrapcp.RoutingModel_GetSameVehicleRequiredTypeAlternativesOfType(
            self, type
        )
    ...
    def GetRequiredTypeAlternativesWhenAddingType(self, type):
        ...
        return _pywrapcp.RoutingModel_GetRequiredTypeAlternativesWhenAddingType(
            self, type
        )
    ...
    def UnperformedPenaltyOrValue(self, default_value, var_index):
        ...
        """
        return _pywrapcp.RoutingModel_UnperformedPenaltyOrValue(
    ...
    def SetMaximumNumberOfActiveVehicles(self, max_active_vehicles):
        ...
        """
        return _pywrapcp.RoutingModel_SetMaximumNumberOfActiveVehicles(
    ...
    def SetArcCostEvaluatorOfAllVehicles(self, evaluator_index):
        ...
        """
        return _pywrapcp.RoutingModel_SetArcCostEvaluatorOfAllVehicles(
    ...
    def SetPathEnergyCostOfVehicle(self, force, distance, unit_cost, vehicle):
        return _pywrapcp.RoutingModel_SetPathEnergyCostOfVehicle(
            self, force, distance, unit_cost, vehicle
        )

    def SetAmortizedCostFactorsOfAllVehicles(
        self, linear_cost_factor, quadratic_cost_factor
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_SetAmortizedCostFactorsOfAllVehicles(
            self, linear_cost_factor, quadratic_cost_factor
        )
    ...
    def SetAmortizedCostFactorsOfVehicle(
        ...
        return _pywrapcp.RoutingModel_SetAmortizedCostFactorsOfVehicle(
            self, linear_cost_factor, quadratic_cost_factor, vehicle
        )
    ...
    def AddAtSolutionCallback(self, callback, track_unchecked_neighbors=False):
        ...
        return _pywrapcp.RoutingModel_AddAtSolutionCallback(
            self, callback, track_unchecked_neighbors
        )
    ...
    def AddWeightedVariableMinimizedByFinalizer(self, var, cost):
        ...
        """
        return _pywrapcp.RoutingModel_AddWeightedVariableMinimizedByFinalizer(
            self, var, cost
        )
    ...
    def AddWeightedVariableMaximizedByFinalizer(self, var, cost):
        ...
        priority: the higher the more priority it has.
        """
        return _pywrapcp.RoutingModel_AddWeightedVariableMaximizedByFinalizer(
            self, var, cost
        )
    ...
    def AddWeightedVariableTargetToFinalizer(self, var, target, cost):
        ...
        """
        return _pywrapcp.RoutingModel_AddWeightedVariableTargetToFinalizer(
            self, var, target, cost
        )
    ...
    def SolveWithParameters(self, search_parameters, solutions=None):
        ...
        deleted.
        """
        return _pywrapcp.RoutingModel_SolveWithParameters(
            self, search_parameters, solutions
        )

    def SolveFromAssignmentWithParameters(
        self, assignment, search_parameters, solutions=None
    ):
        r"""
        Same as above, except that if assignment is not null, it will be used as
        the initial solution.
        """
        return _pywrapcp.RoutingModel_SolveFromAssignmentWithParameters(
            self, assignment, search_parameters, solutions
        )

    def FastSolveFromAssignmentWithParameters(
        self, assignment, search_parameters, check_solution_in_cp, touched=None
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_FastSolveFromAssignmentWithParameters(
            self, assignment, search_parameters, check_solution_in_cp, touched
        )

    def SolveFromAssignmentsWithParameters(
        self, assignments, search_parameters, solutions=None
    ):
        r"""
        Same as above but will try all assignments in order as first solutions
        until one succeeds.
        """
        return _pywrapcp.RoutingModel_SolveFromAssignmentsWithParameters(
            self, assignments, search_parameters, solutions
        )
    ...
    def SolveWithIteratedLocalSearch(self, search_parameters):
        ...
        approach.
        """
        return _pywrapcp.RoutingModel_SolveWithIteratedLocalSearch(
            self, search_parameters
        )

    def SetAssignmentFromOtherModelAssignment(
        self, target_assignment, source_model, source_assignment
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_SetAssignmentFromOtherModelAssignment(
            self, target_assignment, source_model, source_assignment
        )
    ...
    def RoutesToAssignment(
        self, routes, ignore_inactive_indices, close_routes, assignment
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_RoutesToAssignment(
            self, routes, ignore_inactive_indices, close_routes, assignment
        )
    ...
    def PackCumulsOfOptimizerDimensionsFromAssignment(
        self, original_assignment, duration_limit, time_limit_was_reached=None
    ):
        r"""
        ...
        """
        return _pywrapcp.RoutingModel_PackCumulsOfOptimizerDimensionsFromAssignment(
    ...
    def GetArcCostForVehicle(self, from_index, to_index, vehicle):
        ...
        """
        return _pywrapcp.RoutingModel_GetArcCostForVehicle(
            self, from_index, to_index, vehicle
        )
    ...
    def GetArcCostForFirstSolution(self, from_index, to_index):
        ...
        """
        return _pywrapcp.RoutingModel_GetArcCostForFirstSolution(
    ...
    def GetArcCostForClass(self, from_index, to_index, cost_class_index):
        ...
        for details.
        """
        return _pywrapcp.RoutingModel_GetArcCostForClass(
            self, from_index, to_index, cost_class_index
        )
    ...
    def HasVehicleWithCostClassIndex(self, cost_class_index):
        ...
        cost_class_index.
        """
        return _pywrapcp.RoutingModel_HasVehicleWithCostClassIndex(
            self, cost_class_index
        )
    ...
    def DebugOutputAssignment(self, solution_assignment, dimension_to_print):
        ...
        """
        return _pywrapcp.RoutingModel_DebugOutputAssignment(
            self, solution_assignment, dimension_to_print
        )
    ...
    def CheckIfAssignmentIsFeasible(self, assignment, call_at_solution_monitors):
        ...
        """
        return _pywrapcp.RoutingModel_CheckIfAssignmentIsFeasible(
            self, assignment, call_at_solution_monitors
        )
    ...
    def GetNumberOfDecisionsInFirstSolution(self, search_parameters):
        ...
        """
        return _pywrapcp.RoutingModel_GetNumberOfDecisionsInFirstSolution(
            self, search_parameters
        )

    def GetNumberOfRejectsInFirstSolution(self, search_parameters):
        return _pywrapcp.RoutingModel_GetNumberOfRejectsInFirstSolution(
            self, search_parameters
        )
    ...
    def MakeGuidedSlackFinalizer(self, dimension, initializer):
        ...
        """
        return _pywrapcp.RoutingModel_MakeGuidedSlackFinalizer(
            self, dimension, initializer
        )
    ...
    def MakeSelfDependentDimensionFinalizer(self, dimension):
        ...
        number of vehicles.
        """
        return _pywrapcp.RoutingModel_MakeSelfDependentDimensionFinalizer(
            self, dimension
        )
...
class RoutingModelVisitor(BaseObject):
    ...
    def __init__(self):
        _pywrapcp.RoutingModelVisitor_swiginit(
            self, _pywrapcp.new_RoutingModelVisitor()
        )
...
class GlobalVehicleBreaksConstraint(Constraint):
    ...
    def __init__(self, dimension):
        _pywrapcp.GlobalVehicleBreaksConstraint_swiginit(
...
class TypeRegulationsChecker(object):
    ...
    def CheckVehicle(self, vehicle, next_accessor):
        return _pywrapcp.TypeRegulationsChecker_CheckVehicle(
            self, vehicle, next_accessor
        )
...
class TypeIncompatibilityChecker(TypeRegulationsChecker):
    ...
    def __init__(self, model, check_hard_incompatibilities):
        _pywrapcp.TypeIncompatibilityChecker_swiginit(
            self,
            _pywrapcp.new_TypeIncompatibilityChecker(
                model, check_hard_incompatibilities
            ),
        )
...
class TypeRequirementChecker(TypeRegulationsChecker):
    ...
    def __init__(self, model):
        _pywrapcp.TypeRequirementChecker_swiginit(
            self, _pywrapcp.new_TypeRequirementChecker(model)
        )
...
class TypeRegulationsConstraint(Constraint):
    ...
    def __init__(self, model):
        _pywrapcp.TypeRegulationsConstraint_swiginit(
            self, _pywrapcp.new_TypeRegulationsConstraint(model)
        )
...
class SimpleBoundCosts(object):
    ...
    def __init__(self, num_bounds, default_bound_cost):
        _pywrapcp.SimpleBoundCosts_swiginit(
            self, _pywrapcp.new_SimpleBoundCosts(num_bounds, default_bound_cost)
        )
...
class RoutingDimension(object):
    ...
    def GetTransitValue(self, from_index, to_index, vehicle):
        ...
        """
        return _pywrapcp.RoutingDimension_GetTransitValue(
            self, from_index, to_index, vehicle
        )
    ...
    def GetTransitValueFromClass(self, from_index, to_index, vehicle_class):
        ...
        """
        return _pywrapcp.RoutingDimension_GetTransitValueFromClass(
            self, from_index, to_index, vehicle_class
        )
    ...
    def SetSpanUpperBoundForVehicle(self, upper_bound, vehicle):
        ...
        a dimension.
        """
        return _pywrapcp.RoutingDimension_SetSpanUpperBoundForVehicle(
            self, upper_bound, vehicle
        )
    ...
    def SetSpanCostCoefficientForVehicle(self, coefficient, vehicle):
        ...
        """
        return _pywrapcp.RoutingDimension_SetSpanCostCoefficientForVehicle(
            self, coefficient, vehicle
        )

    def SetSpanCostCoefficientForAllVehicles(self, coefficient):
        return _pywrapcp.RoutingDimension_SetSpanCostCoefficientForAllVehicles(
            self, coefficient
        )
    ...
    def SetSlackCostCoefficientForVehicle(self, coefficient, vehicle):
        ...
        """
        return _pywrapcp.RoutingDimension_SetSlackCostCoefficientForVehicle(
            self, coefficient, vehicle
        )

    def SetSlackCostCoefficientForAllVehicles(self, coefficient):
        return _pywrapcp.RoutingDimension_SetSlackCostCoefficientForAllVehicles(
            self, coefficient
        )
    ...
    def SetGlobalSpanCostCoefficient(self, coefficient):
        ...
        """
        return _pywrapcp.RoutingDimension_SetGlobalSpanCostCoefficient(
            self, coefficient
        )
    ...
    def SetCumulVarSoftUpperBound(self, index, upper_bound, coefficient):
        ...
        time.
        """
        return _pywrapcp.RoutingDimension_SetCumulVarSoftUpperBound(
    ...
    def GetCumulVarSoftUpperBoundCoefficient(self, index):
        ...
        returned.
        """
        return _pywrapcp.RoutingDimension_GetCumulVarSoftUpperBoundCoefficient(
            self, index
        )
    ...
    def SetCumulVarSoftLowerBound(self, index, lower_bound, coefficient):
        ...
        time.
        """
        return _pywrapcp.RoutingDimension_SetCumulVarSoftLowerBound(
            self, index, lower_bound, coefficient
        )
    ...
    def SetBreakIntervalsOfVehicle(self, breaks, vehicle, node_visit_transits):
        ...
        """
        return _pywrapcp.RoutingDimension_SetBreakIntervalsOfVehicle(
            self, breaks, vehicle, node_visit_transits
        )
    ...
    def SetBreakDistanceDurationOfVehicle(self, distance, duration, vehicle):
        ...
        infinite breaks.
        """
        return _pywrapcp.RoutingDimension_SetBreakDistanceDurationOfVehicle(
            self, distance, duration, vehicle
        )
    ...
    def SetPickupToDeliveryLimitFunctionForPair(self, limit_function, pair_index):
        return _pywrapcp.RoutingDimension_SetPickupToDeliveryLimitFunctionForPair(
            self, limit_function, pair_index
        )
    ...
    def AddNodePrecedence(self, first_node, second_node, offset):
        return _pywrapcp.RoutingDimension_AddNodePrecedence(
            self, first_node, second_node, offset
        )
    ...
    def GetSpanCostCoefficientForVehicle(self, vehicle):
        return _pywrapcp.RoutingDimension_GetSpanCostCoefficientForVehicle(
            self, vehicle
        )

    def GetSlackCostCoefficientForVehicle(self, vehicle):
        return _pywrapcp.RoutingDimension_GetSlackCostCoefficientForVehicle(
            self, vehicle
        )
    ...
    def GetLocalOptimizerOffsetForVehicle(self, vehicle):
        return _pywrapcp.RoutingDimension_GetLocalOptimizerOffsetForVehicle(
            self, vehicle
        )
    ...
    def SetSoftSpanUpperBoundForVehicle(self, bound_cost, vehicle):
        ...
        """
        return _pywrapcp.RoutingDimension_SetSoftSpanUpperBoundForVehicle(
    ...
    def SetQuadraticCostSoftSpanUpperBoundForVehicle(self, bound_cost, vehicle):
        ...
        """
        return _pywrapcp.RoutingDimension_SetQuadraticCostSoftSpanUpperBoundForVehicle(
            self, bound_cost, vehicle
        )
    ...
    def GetQuadraticCostSoftSpanUpperBoundForVehicle(self, vehicle):
        return _pywrapcp.RoutingDimension_GetQuadraticCostSoftSpanUpperBoundForVehicle(
            self, vehicle
        )
...
def SolveModelWithSat(model, search_parameters, initial_solution, solution):
    ...
    """
    return _pywrapcp.SolveModelWithSat(
        model, search_parameters, initial_solution, solution
    )

...
class ModelSubsetProto(google.protobuf.message.Message):
    ...
    def variable_bounds(
        ...
        builtins.int, global___ModelSubsetProto.Bounds
    ]:
    ...
    def __init__(
        self,
        *,
        variable_bounds: collections.abc.Mapping[
            builtins.int, global___ModelSubsetProto.Bounds
        ]
        | None = ...,
        variable_integrality: collections.abc.Iterable[builtins.int] | None = ...,
        linear_constraints: collections.abc.Mapping[
            builtins.int, global___ModelSubsetProto.Bounds
        ]
        | None = ...,
        ...
        | None = ...,
        second_order_cone_constraints: collections.abc.Iterable[builtins.int]
        | None = ...,
...
class ComputeInfeasibleSubsystemResultProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["infeasible_subsystem", b"infeasible_subsystem"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[

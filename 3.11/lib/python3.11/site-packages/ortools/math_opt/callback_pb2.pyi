...
class _CallbackEventProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _CallbackEventProto.ValueType
    ],
    builtins.type,
):
...
class CallbackEventProto(
    _CallbackEventProto, metaclass=_CallbackEventProtoEnumTypeWrapper
):
...
class CallbackDataProto(google.protobuf.message.Message):
    ...
    class PresolveStats(google.protobuf.message.Message):
        ...
        def HasField(
            ...
            field_name: typing.Literal[
                "_bound_changes",
                b"_bound_changes",
                "_coefficient_changes",
                b"_coefficient_changes",
                "_removed_constraints",
                b"_removed_constraints",
                "_removed_variables",
                b"_removed_variables",
                "bound_changes",
                b"bound_changes",
                "coefficient_changes",
                b"coefficient_changes",
                "removed_constraints",
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_bound_changes", b"_bound_changes"]
        ) -> typing.Literal["bound_changes"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_coefficient_changes", b"_coefficient_changes"
            ],
        ) -> typing.Literal["coefficient_changes"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_removed_constraints", b"_removed_constraints"
            ],
        ) -> typing.Literal["removed_constraints"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal["_removed_variables", b"_removed_variables"],
        ) -> typing.Literal["removed_variables"] | None: ...
    ...
    class SimplexStats(google.protobuf.message.Message):
        ...
        def HasField(
            ...
            field_name: typing.Literal[
                ...
                b"_primal_infeasibility",
                "dual_infeasibility",
                b"dual_infeasibility",
                "is_pertubated",
                b"is_pertubated",
                "iteration_count",
                b"iteration_count",
        ...
        def WhichOneof(
            self,
            oneof_group: typing.Literal["_dual_infeasibility", b"_dual_infeasibility"],
        ) -> typing.Literal["dual_infeasibility"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_is_pertubated", b"_is_pertubated"]
        ) -> typing.Literal["is_pertubated"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_iteration_count", b"_iteration_count"]
        ) -> typing.Literal["iteration_count"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_objective_value", b"_objective_value"]
        ) -> typing.Literal["objective_value"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_primal_infeasibility", b"_primal_infeasibility"
            ],
        ) -> typing.Literal["primal_infeasibility"] | None: ...
    ...
    class BarrierStats(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_complementarity", b"_complementarity"]
        ) -> typing.Literal["complementarity"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal["_dual_infeasibility", b"_dual_infeasibility"],
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_dual_objective", b"_dual_objective"]
        ) -> typing.Literal["dual_objective"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_iteration_count", b"_iteration_count"]
        ) -> typing.Literal["iteration_count"] | None: ...
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_primal_objective", b"_primal_objective"]
        ) -> typing.Literal["primal_objective"] | None: ...
    ...
    class MipStats(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing.Literal[
                "_cutting_planes_in_lp",
                b"_cutting_planes_in_lp",
                "_dual_bound",
                b"_dual_bound",
                "_explored_nodes",
                b"_explored_nodes",
                "_number_of_solutions_found",
                ...
                b"_primal_bound",
                "_simplex_iterations",
                b"_simplex_iterations",
                "cutting_planes_in_lp",
                b"cutting_planes_in_lp",
                "dual_bound",
                b"dual_bound",
                "explored_nodes",
                b"explored_nodes",
                "number_of_solutions_found",
                b"number_of_solutions_found",
                "open_nodes",
                b"open_nodes",
                "primal_bound",
                b"primal_bound",
                "simplex_iterations",
                b"simplex_iterations",
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
        ...
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_cutting_planes_in_lp", b"_cutting_planes_in_lp"
            ],
        ) -> typing.Literal["cutting_planes_in_lp"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_dual_bound", b"_dual_bound"]
        ) -> typing.Literal["dual_bound"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_explored_nodes", b"_explored_nodes"]
        ) -> typing.Literal["explored_nodes"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_number_of_solutions_found", b"_number_of_solutions_found"
            ],
        ) -> typing.Literal["number_of_solutions_found"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_open_nodes", b"_open_nodes"]
        ) -> typing.Literal["open_nodes"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_primal_bound", b"_primal_bound"]
        ) -> typing.Literal["primal_bound"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal["_simplex_iterations", b"_simplex_iterations"],
        ) -> typing.Literal["simplex_iterations"] | None: ...
    ...
    @property
    def primal_solution_vector(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto:
    ...
    def __init__(
        ...
        *,
        event: global___CallbackEventProto.ValueType = ...,
        primal_solution_vector: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
...
class CallbackResultProto(google.protobuf.message.Message):
    ...
    class GeneratedLinearConstraint(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            linear_expression: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
            | None = ...,
            lower_bound: builtins.float = ...,
            upper_bound: builtins.float = ...,
            is_lazy: builtins.bool = ...,
        ...
        def HasField(
            self, field_name: typing.Literal["linear_expression", b"linear_expression"]
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing.Literal[
    ...
    def cuts(
        ...
        global___CallbackResultProto.GeneratedLinearConstraint
    ]:
    ...
    def __init__(
        ...
        *,
        terminate: builtins.bool = ...,
        cuts: collections.abc.Iterable[
            global___CallbackResultProto.GeneratedLinearConstraint
        ]
        | None = ...,
        suggested_solutions: collections.abc.Iterable[
            ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        ]
        | None = ...,
    ) -> None: ...
...
class CallbackRegistrationProto(google.protobuf.message.Message):
    ...
    * how the callback might alter the solve process.
    ...
    def request_registration(
        ...
        global___CallbackEventProto.ValueType
    ]:
        ...
        """
    @property
    def mip_solution_filter(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.SparseVectorFilterProto:
    ...
    def __init__(
        self,
        *,
        request_registration: collections.abc.Iterable[
            global___CallbackEventProto.ValueType
        ]
        | None = ...,
        mip_solution_filter: ortools.math_opt.sparse_containers_pb2.SparseVectorFilterProto
        | None = ...,
        mip_node_filter: ortools.math_opt.sparse_containers_pb2.SparseVectorFilterProto
        | None = ...,
        add_cuts: builtins.bool = ...,
        add_lazy_constraints: builtins.bool = ...,
    ) -> None: ...
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"add_lazy_constraints",
            "mip_node_filter",
            b"mip_node_filter",
            "mip_solution_filter",
            b"mip_solution_filter",
            "request_registration",
            b"request_registration",
        ],
    ) -> None: ...

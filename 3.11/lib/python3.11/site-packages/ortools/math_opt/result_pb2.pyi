...
class _FeasibilityStatusProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _FeasibilityStatusProto.ValueType
    ],
    builtins.type,
):
...
class FeasibilityStatusProto(
    _FeasibilityStatusProto, metaclass=_FeasibilityStatusProtoEnumTypeWrapper
):
...
class _TerminationReasonProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _TerminationReasonProto.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class TerminationReasonProto(
    _TerminationReasonProto, metaclass=_TerminationReasonProtoEnumTypeWrapper
):
...
class _LimitProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_LimitProto.ValueType],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SolveStatsProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "problem_status", b"problem_status", "solve_time", b"solve_time"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "barrier_iterations",
            b"barrier_iterations",
            "best_dual_bound",
            b"best_dual_bound",
            "best_primal_bound",
            b"best_primal_bound",
            "first_order_iterations",
            b"first_order_iterations",
            "node_count",
            b"node_count",
            "problem_status",
            b"problem_status",
...
class ObjectiveBoundsProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "dual_bound", b"dual_bound", "primal_bound", b"primal_bound"
        ],
    ) -> None: ...
...
class TerminationProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "objective_bounds", b"objective_bounds", "problem_status", b"problem_status"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SolveResultProto(google.protobuf.message.Message):
    ...
    class PdlpOutput(google.protobuf.message.Message):
        ...
        def convergence_information(
            self,
        ) -> ortools.pdlp.solve_log_pb2.ConvergenceInformation: ...
        def __init__(
            self,
            *,
            convergence_information: ortools.pdlp.solve_log_pb2.ConvergenceInformation
            | None = ...,
        ) -> None: ...
        def HasField(
            self,
            field_name: typing.Literal[
                "convergence_information", b"convergence_information"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    def solutions(
        ...
        ortools.math_opt.solution_pb2.SolutionProto
    ]:
    ...
    def primal_rays(
        ...
        ortools.math_opt.solution_pb2.PrimalRayProto
    ]:
    ...
    def dual_rays(
        ...
        ortools.math_opt.solution_pb2.DualRayProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        solutions: collections.abc.Iterable[ortools.math_opt.solution_pb2.SolutionProto]
        | None = ...,
        primal_rays: collections.abc.Iterable[
            ortools.math_opt.solution_pb2.PrimalRayProto
        ]
        | None = ...,
        dual_rays: collections.abc.Iterable[ortools.math_opt.solution_pb2.DualRayProto]
        | None = ...,
    ...
    def WhichOneof(
        ...
        oneof_group: typing.Literal[
            "solver_specific_output", b"solver_specific_output"
        ],
    ) -> typing.Literal["gscip_output", "osqp_output", "pdlp_output"] | None: ...

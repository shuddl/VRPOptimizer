...
class SolverResourcesProto(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_cpu", b"_cpu", "_ram", b"_ram", "cpu", b"cpu", "ram", b"ram"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_cpu", b"_cpu"]
    ) -> typing.Literal["cpu"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_ram", b"_ram"]
    ) -> typing.Literal["ram"] | None: ...
...
class SolveRequest(google.protobuf.message.Message):
    ...
    def model_parameters(
        self,
    ) -> ortools.math_opt.model_parameters_pb2.ModelSolveParametersProto:
    ...
    def __init__(
        ...
        *,
        ...
        initializer: ortools.math_opt.parameters_pb2.SolverInitializerProto
        | None = ...,
        parameters: ortools.math_opt.parameters_pb2.SolveParametersProto | None = ...,
        model_parameters: ortools.math_opt.model_parameters_pb2.ModelSolveParametersProto
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class SolveResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "result", b"result", "status", b"status", "status_or", b"status_or"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["status_or", b"status_or"]
    ) -> typing.Literal["result", "status"] | None: ...

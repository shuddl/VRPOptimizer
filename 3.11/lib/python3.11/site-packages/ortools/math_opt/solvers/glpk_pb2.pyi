...
class GlpkParametersProto(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_compute_unbound_rays_if_possible",
            b"_compute_unbound_rays_if_possible",
            "compute_unbound_rays_if_possible",
            b"compute_unbound_rays_if_possible",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        ...
        oneof_group: typing.Literal[
            "_compute_unbound_rays_if_possible", b"_compute_unbound_rays_if_possible"
        ],
    ) -> typing.Literal["compute_unbound_rays_if_possible"] | None: ...

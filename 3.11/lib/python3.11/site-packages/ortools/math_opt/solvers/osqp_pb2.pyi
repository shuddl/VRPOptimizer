...
class OsqpSettingsProto(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_adaptive_rho",
            b"_adaptive_rho",
            "_adaptive_rho_fraction",
            b"_adaptive_rho_fraction",
            "_adaptive_rho_interval",
            b"_adaptive_rho_interval",
            "_adaptive_rho_tolerance",
            b"_adaptive_rho_tolerance",
            "_alpha",
            b"_alpha",
            "_check_termination",
            b"_check_termination",
            "_delta",
            b"_delta",
            "_eps_abs",
            b"_eps_abs",
            ...
            b"_polish",
            "_polish_refine_iter",
            b"_polish_refine_iter",
            "_rho",
            b"_rho",
            "_scaled_termination",
            b"_scaled_termination",
            "_scaling",
            b"_scaling",
            "_sigma",
            b"_sigma",
            ...
            b"adaptive_rho_fraction",
            "adaptive_rho_interval",
            b"adaptive_rho_interval",
            "adaptive_rho_tolerance",
            b"adaptive_rho_tolerance",
            "alpha",
            b"alpha",
            "check_termination",
            b"check_termination",
            ...
            b"polish",
            "polish_refine_iter",
            b"polish_refine_iter",
            "rho",
            b"rho",
            "scaled_termination",
            b"scaled_termination",
            "scaling",
            b"scaling",
            "sigma",
            b"sigma",
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_adaptive_rho", b"_adaptive_rho"]
    ) -> typing.Literal["adaptive_rho"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_adaptive_rho_fraction", b"_adaptive_rho_fraction"
        ],
    ) -> typing.Literal["adaptive_rho_fraction"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_adaptive_rho_interval", b"_adaptive_rho_interval"
        ],
    ) -> typing.Literal["adaptive_rho_interval"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_adaptive_rho_tolerance", b"_adaptive_rho_tolerance"
        ],
    ) -> typing.Literal["adaptive_rho_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_alpha", b"_alpha"]
    ) -> typing.Literal["alpha"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_check_termination", b"_check_termination"]
    ) -> typing.Literal["check_termination"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_delta", b"_delta"]
    ) -> typing.Literal["delta"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_eps_abs", b"_eps_abs"]
    ) -> typing.Literal["eps_abs"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_eps_dual_inf", b"_eps_dual_inf"]
    ) -> typing.Literal["eps_dual_inf"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_eps_prim_inf", b"_eps_prim_inf"]
    ) -> typing.Literal["eps_prim_inf"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_eps_rel", b"_eps_rel"]
    ) -> typing.Literal["eps_rel"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_max_iter", b"_max_iter"]
    ) -> typing.Literal["max_iter"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_polish", b"_polish"]
    ) -> typing.Literal["polish"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_polish_refine_iter", b"_polish_refine_iter"]
    ) -> typing.Literal["polish_refine_iter"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_rho", b"_rho"]
    ) -> typing.Literal["rho"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_scaled_termination", b"_scaled_termination"]
    ) -> typing.Literal["scaled_termination"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_scaling", b"_scaling"]
    ) -> typing.Literal["scaling"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_sigma", b"_sigma"]
    ) -> typing.Literal["sigma"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_time_limit", b"_time_limit"]
    ) -> typing.Literal["time_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_verbose", b"_verbose"]
    ) -> typing.Literal["verbose"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_warm_start", b"_warm_start"]
...
class OsqpOutput(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "initialized_underlying_solver", b"initialized_underlying_solver"
        ],
    ) -> None: ...

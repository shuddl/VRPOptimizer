...
class GurobiInitializerProto(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["isv_key", b"isv_key"]
    ) -> builtins.bool: ...
...
class GurobiParametersProto(google.protobuf.message.Message):
    ...
    def parameters(
        ...
        global___GurobiParametersProto.Parameter
    ]: ...
    def __init__(
        self,
        *,
        parameters: collections.abc.Iterable[global___GurobiParametersProto.Parameter]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["parameters", b"parameters"]
    ) -> None: ...

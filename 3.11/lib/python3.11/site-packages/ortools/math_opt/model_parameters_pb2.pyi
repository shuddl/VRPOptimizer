...
class SolutionHintProto(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "dual_values", b"dual_values", "variable_values", b"variable_values"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ObjectiveParametersProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_objective_degradation_absolute_tolerance",
            b"_objective_degradation_absolute_tolerance",
            "_objective_degradation_relative_tolerance",
            b"_objective_degradation_relative_tolerance",
            "objective_degradation_absolute_tolerance",
            b"objective_degradation_absolute_tolerance",
            "objective_degradation_relative_tolerance",
            b"objective_degradation_relative_tolerance",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing.Literal["objective_degradation_absolute_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
    ...
    ) -> typing.Literal["objective_degradation_relative_tolerance"] | None: ...
...
class ModelSolveParametersProto(google.protobuf.message.Message):
    ...
    def dual_values_filter(
        ...
        """
    @property
    def quadratic_dual_values_filter(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.SparseVectorFilterProto:
    ...
    def solution_hints(
        ...
        global___SolutionHintProto
    ]:
        """Optional solution hints. If the underlying solver only accepts a single
        hint, the first hint is used.
        """
    @property
    def branching_priorities(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.SparseInt32VectorProto:
    ...
    @property
    def auxiliary_objective_parameters(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[
        builtins.int, global___ObjectiveParametersProto
    ]:
        ...
        """
    @property
    def lazy_linear_constraint_ids(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        solution_hints: collections.abc.Iterable[global___SolutionHintProto]
        | None = ...,
        ...
        auxiliary_objective_parameters: collections.abc.Mapping[
            builtins.int, global___ObjectiveParametersProto
        ]
        | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"branching_priorities",
            "dual_values_filter",
            b"dual_values_filter",
            "initial_basis",
            b"initial_basis",
            "primary_objective_parameters",
            b"primary_objective_parameters",
            "quadratic_dual_values_filter",
            b"quadratic_dual_values_filter",
            "reduced_costs_filter",
            b"reduced_costs_filter",
            "variable_values_filter",
            b"variable_values_filter",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            ...
            b"auxiliary_objective_parameters",
            "branching_priorities",
            b"branching_priorities",
            "dual_values_filter",
            b"dual_values_filter",
            "initial_basis",
            b"initial_basis",
            "lazy_linear_constraint_ids",
            b"lazy_linear_constraint_ids",
            "primary_objective_parameters",
            b"primary_objective_parameters",
            "quadratic_dual_values_filter",
            b"quadratic_dual_values_filter",

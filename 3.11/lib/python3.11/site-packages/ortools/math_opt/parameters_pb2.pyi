...
class _SolverTypeProtoEnumTypeWrapper(
...
class _LPAlgorithmProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _LPAlgorithmProto.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _EmphasisProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _EmphasisProto.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class StrictnessProto(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["bad_parameter", b"bad_parameter"]
    ) -> None: ...
...
class SolverInitializerProto(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["gurobi", b"gurobi"]
    ) -> builtins.bool: ...
...
class SolveParametersProto(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            "_random_seed",
            b"_random_seed",
            "_relative_gap_tolerance",
            b"_relative_gap_tolerance",
            "_solution_limit",
            b"_solution_limit",
            "_solution_pool_size",
            b"_solution_pool_size",
            "_threads",
            b"_threads",
            "absolute_gap_tolerance",
            b"absolute_gap_tolerance",
            "best_bound_limit",
            b"best_bound_limit",
            "cp_sat",
            b"cp_sat",
    ...
    def WhichOneof(
        ...
        oneof_group: typing.Literal[
            "_absolute_gap_tolerance", b"_absolute_gap_tolerance"
        ],
    ) -> typing.Literal["absolute_gap_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_best_bound_limit", b"_best_bound_limit"]
    ) -> typing.Literal["best_bound_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_cutoff_limit", b"_cutoff_limit"]
    ) -> typing.Literal["cutoff_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_iteration_limit", b"_iteration_limit"]
    ) -> typing.Literal["iteration_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_node_limit", b"_node_limit"]
    ) -> typing.Literal["node_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_objective_limit", b"_objective_limit"]
    ) -> typing.Literal["objective_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_random_seed", b"_random_seed"]
    ) -> typing.Literal["random_seed"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_relative_gap_tolerance", b"_relative_gap_tolerance"
        ],
    ) -> typing.Literal["relative_gap_tolerance"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_solution_limit", b"_solution_limit"]
    ) -> typing.Literal["solution_limit"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_solution_pool_size", b"_solution_pool_size"]
    ) -> typing.Literal["solution_pool_size"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_threads", b"_threads"]
    ) -> typing.Literal["threads"] | None: ...

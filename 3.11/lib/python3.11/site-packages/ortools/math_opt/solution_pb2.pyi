...
class DualSolutionProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        | None = ...,
        quadratic_dual_values: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        reduced_costs: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,

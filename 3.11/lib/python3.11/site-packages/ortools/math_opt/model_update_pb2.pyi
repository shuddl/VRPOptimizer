...
class ObjectiveUpdatesProto(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_direction_update", b"_direction_update"]
    ) -> typing.Literal["direction_update"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_offset_update", b"_offset_update"]
    ) -> typing.Literal["offset_update"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_priority_update", b"_priority_update"]
    ) -> typing.Literal["priority_update"] | None: ...
...
class AuxiliaryObjectivesUpdatesProto(google.protobuf.message.Message):
    ...
    def new_objectives(
        ...
        builtins.int, ortools.math_opt.model_pb2.ObjectiveProto
    ]:
        ...
        """
    @property
    def objective_updates(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[
        builtins.int, global___ObjectiveUpdatesProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        new_objectives: collections.abc.Mapping[
            builtins.int, ortools.math_opt.model_pb2.ObjectiveProto
        ]
        | None = ...,
        objective_updates: collections.abc.Mapping[
            builtins.int, global___ObjectiveUpdatesProto
        ]
        | None = ...,
    ) -> None: ...
...
class LinearConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "lower_bounds", b"lower_bounds", "upper_bounds", b"upper_bounds"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class QuadraticConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def new_constraints(
        ...
        builtins.int, ortools.math_opt.model_pb2.QuadraticConstraintProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        new_constraints: collections.abc.Mapping[
            builtins.int, ortools.math_opt.model_pb2.QuadraticConstraintProto
        ]
        | None = ...,
    ) -> None: ...
...
class SecondOrderConeConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    class NewConstraintsEntry(google.protobuf.message.Message):
        ...
        def value(
            self,
        ) -> ortools.math_opt.model_pb2.SecondOrderConeConstraintProto: ...
        def __init__(
            self,
            *,
            key: builtins.int = ...,
            value: ortools.math_opt.model_pb2.SecondOrderConeConstraintProto
            | None = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing.Literal["value", b"value"]
    ...
    def new_constraints(
        ...
        builtins.int, ortools.math_opt.model_pb2.SecondOrderConeConstraintProto
    ]:
...
class SosConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def new_constraints(
        ...
        builtins.int, ortools.math_opt.model_pb2.SosConstraintProto
    ]:
...
class IndicatorConstraintUpdatesProto(google.protobuf.message.Message):
    ...
    def new_constraints(
        ...
        builtins.int, ortools.math_opt.model_pb2.IndicatorConstraintProto
    ]:
...
class ModelUpdateProto(google.protobuf.message.Message):
    ...
    def deleted_variable_ids(
        ...
        """
    @property
    def deleted_linear_constraint_ids(
        self,
    ) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
    ...
    def new_variables(self) -> ortools.math_opt.model_pb2.VariablesProto:
        ...
        """
    @property
    def new_linear_constraints(
        self,
    ) -> ortools.math_opt.model_pb2.LinearConstraintsProto:
    ...
    @property
    def linear_constraint_matrix_updates(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.SparseDoubleMatrixProto:
    ...
    @property
    def second_order_cone_constraint_updates(
        self,
    ) -> global___SecondOrderConeConstraintUpdatesProto:
    ...
    @property
    def indicator_constraint_updates(
        self,
    ) -> global___IndicatorConstraintUpdatesProto: ...
    def __init__(
        self,
        *,
        deleted_variable_ids: collections.abc.Iterable[builtins.int] | None = ...,
        deleted_linear_constraint_ids: collections.abc.Iterable[builtins.int]
        | None = ...,
        ...
        auxiliary_objectives_updates: global___AuxiliaryObjectivesUpdatesProto
        | None = ...,
        linear_constraint_matrix_updates: ortools.math_opt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,
        quadratic_constraint_updates: global___QuadraticConstraintUpdatesProto
        | None = ...,
        second_order_cone_constraint_updates: global___SecondOrderConeConstraintUpdatesProto
        | None = ...,
        ...
        indicator_constraint_updates: global___IndicatorConstraintUpdatesProto
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            ...
            b"auxiliary_objectives_updates",
            "indicator_constraint_updates",
            b"indicator_constraint_updates",
            "linear_constraint_matrix_updates",
            b"linear_constraint_matrix_updates",
            "linear_constraint_updates",
            b"linear_constraint_updates",
            "new_linear_constraints",
            b"new_linear_constraints",
            "new_variables",
            b"new_variables",
            "objective_updates",
            b"objective_updates",
            "quadratic_constraint_updates",
            b"quadratic_constraint_updates",
            "second_order_cone_constraint_updates",
            b"second_order_cone_constraint_updates",
            "sos1_constraint_updates",
            b"sos1_constraint_updates",
            "sos2_constraint_updates",
            b"sos2_constraint_updates",
            "variable_updates",
            b"variable_updates",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "auxiliary_objectives_updates",
            b"auxiliary_objectives_updates",
            "deleted_linear_constraint_ids",
            b"deleted_linear_constraint_ids",
            "deleted_variable_ids",
            b"deleted_variable_ids",
            "indicator_constraint_updates",
            b"indicator_constraint_updates",
            "linear_constraint_matrix_updates",
            b"linear_constraint_matrix_updates",

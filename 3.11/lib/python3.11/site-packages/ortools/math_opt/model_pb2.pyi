...
class QuadraticConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        linear_terms: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        quadratic_terms: ortools.math_opt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,
        lower_bound: builtins.float = ...,
        upper_bound: builtins.float = ...,
        name: builtins.str = ...,
...
class SecondOrderConeConstraintProto(google.protobuf.message.Message):
    ...
    def upper_bound(
        self,
    ) -> ortools.math_opt.sparse_containers_pb2.LinearExpressionProto: ...
    @property
    ...
    def __init__(
        self,
        *,
        upper_bound: ortools.math_opt.sparse_containers_pb2.LinearExpressionProto
        | None = ...,
...
class IndicatorConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        activate_on_zero: builtins.bool = ...,
        expression: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        lower_bound: builtins.float = ...,
        upper_bound: builtins.float = ...,
        name: builtins.str = ...,
...
class ModelProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        linear_constraint_matrix: ortools.math_opt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,

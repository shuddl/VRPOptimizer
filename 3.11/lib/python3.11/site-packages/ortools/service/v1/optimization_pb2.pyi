...
class SolveMathOptModelRequest(google.protobuf.message.Message):
    ...
    def parameters(
        self,
    ) -> ortools.service.v1.mathopt.parameters_pb2.SolveParametersProto:
    ...
    def model_parameters(
        self,
    ) -> ortools.service.v1.mathopt.model_parameters_pb2.ModelSolveParametersProto:
    ...
    def __init__(
        ...
        *,
        ...
        parameters: ortools.service.v1.mathopt.parameters_pb2.SolveParametersProto
        | None = ...,
        model_parameters: ortools.service.v1.mathopt.model_parameters_pb2.ModelSolveParametersProto
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class SolveMathOptModelResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["messages", b"messages", "result", b"result"]
    ) -> None: ...

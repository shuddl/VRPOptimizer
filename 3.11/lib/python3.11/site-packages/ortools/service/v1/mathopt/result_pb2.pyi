...
class SolveResultProto(google.protobuf.message.Message):
    ...
    def solutions(
        ...
        ortools.service.v1.mathopt.solution_pb2.SolutionProto
    ]:
    ...
    def primal_rays(
        ...
        ortools.service.v1.mathopt.solution_pb2.PrimalRayProto
    ]:
    ...
    def dual_rays(
        ...
        ortools.service.v1.mathopt.solution_pb2.DualRayProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        solutions: collections.abc.Iterable[
            ortools.service.v1.mathopt.solution_pb2.SolutionProto
        ]
        | None = ...,
        ...
        | None = ...,
        dual_rays: collections.abc.Iterable[
            ortools.service.v1.mathopt.solution_pb2.DualRayProto
        ]
        | None = ...,
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "solve_stats", b"solve_stats", "termination", b"termination"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,

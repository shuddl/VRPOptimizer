...
class ModelSolveParametersProto(google.protobuf.message.Message):
    ...
    def variable_values_filter(
        self,
    ) -> ortools.service.v1.mathopt.sparse_containers_pb2.SparseVectorFilterProto:
    ...
    def branching_priorities(
        self,
    ) -> ortools.service.v1.mathopt.sparse_containers_pb2.SparseInt32VectorProto:
    ...
    def __init__(
        self,
        *,
        variable_values_filter: ortools.service.v1.mathopt.sparse_containers_pb2.SparseVectorFilterProto
        | None = ...,
        dual_values_filter: ortools.service.v1.mathopt.sparse_containers_pb2.SparseVectorFilterProto
        | None = ...,
        reduced_costs_filter: ortools.service.v1.mathopt.sparse_containers_pb2.SparseVectorFilterProto
        | None = ...,
        ...
        | None = ...,
        branching_priorities: ortools.service.v1.mathopt.sparse_containers_pb2.SparseInt32VectorProto
        | None = ...,
    ) -> None: ...
    def HasField(
        self,

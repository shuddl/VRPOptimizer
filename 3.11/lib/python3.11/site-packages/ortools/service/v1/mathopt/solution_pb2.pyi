...
class _SolutionStatusProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _SolutionStatusProto.ValueType
    ],
    builtins.type,
):
...
class SolutionStatusProto(
    _SolutionStatusProto, metaclass=_SolutionStatusProtoEnumTypeWrapper
):
...
class _BasisStatusProtoEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _BasisStatusProto.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class PrimalSolutionProto(google.protobuf.message.Message):
    ...
    def variable_values(
        ...
        * variable_values.values must all be finite.
        """
    @property
    def auxiliary_objective_values(
        self,
    ...
    def __init__(
        self,
        *,
        variable_values: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        objective_value: builtins.float = ...,
        auxiliary_objective_values: collections.abc.Mapping[
    ...
    def HasField(
        self, field_name: typing.Literal["variable_values", b"variable_values"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "auxiliary_objective_values",
            b"auxiliary_objective_values",
            "feasibility_status",
            b"feasibility_status",
            "objective_value",
            b"objective_value",
            "variable_values",
            b"variable_values",
...
class DualSolutionProto(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        dual_values: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        reduced_costs: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
...
class DualRayProto(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "dual_values", b"dual_values", "reduced_costs", b"reduced_costs"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SparseBasisStatusVector(google.protobuf.message.Message):
    ...
    def values(
        ...
        global___BasisStatusProto.ValueType
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        values: collections.abc.Iterable[global___BasisStatusProto.ValueType]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["ids", b"ids", "values", b"values"]
    ) -> None: ...
...
class SolutionProto(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_basis", b"_basis"]
    ) -> typing.Literal["basis"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_dual_solution", b"_dual_solution"]
    ) -> typing.Literal["dual_solution"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_primal_solution", b"_primal_solution"]
    ) -> typing.Literal["primal_solution"] | None: ...

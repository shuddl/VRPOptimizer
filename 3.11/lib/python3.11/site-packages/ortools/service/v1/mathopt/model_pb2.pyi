...
class ObjectiveProto(google.protobuf.message.Message):
    ...
    def linear_coefficients(
        self,
    ) -> ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto:
    ...
    def quadratic_coefficients(
        self,
    ) -> ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleMatrixProto:
    ...
    def __init__(
        ...
        *,
        maximize: builtins.bool = ...,
        offset: builtins.float = ...,
        linear_coefficients: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        quadratic_coefficients: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,
        name: builtins.str = ...,
        priority: builtins.int = ...,
    ) -> None: ...
...
class QuadraticConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        linear_terms: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        quadratic_terms: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,
        lower_bound: builtins.float = ...,
        upper_bound: builtins.float = ...,
        name: builtins.str = ...,
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "linear_terms", b"linear_terms", "quadratic_terms", b"quadratic_terms"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SecondOrderConeConstraintProto(google.protobuf.message.Message):
    ...
    def upper_bound(
        self,
    ) -> ortools.service.v1.mathopt.sparse_containers_pb2.LinearExpressionProto: ...
    @property
    def arguments_to_norm(
        self,
    ...
    def __init__(
        self,
        *,
        upper_bound: ortools.service.v1.mathopt.sparse_containers_pb2.LinearExpressionProto
        | None = ...,
        arguments_to_norm: collections.abc.Iterable[
            ortools.service.v1.mathopt.sparse_containers_pb2.LinearExpressionProto
        ]
        | None = ...,
        name: builtins.str = ...,
    ...
    def HasField(
        self, field_name: typing.Literal["upper_bound", b"upper_bound"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class SosConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        expressions: collections.abc.Iterable[
            ortools.service.v1.mathopt.sparse_containers_pb2.LinearExpressionProto
        ]
        | None = ...,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "expressions", b"expressions", "name", b"name", "weights", b"weights"
        ],
    ) -> None: ...
...
class IndicatorConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        activate_on_zero: builtins.bool = ...,
        expression: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleVectorProto
        | None = ...,
        lower_bound: builtins.float = ...,
        upper_bound: builtins.float = ...,
        name: builtins.str = ...,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_indicator_id", b"_indicator_id"]
    ) -> typing.Literal["indicator_id"] | None: ...
...
class ModelProto(google.protobuf.message.Message):
    ...
    @property
    def auxiliary_objectives(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[
        builtins.int, global___ObjectiveProto
    ]:
    ...
    def quadratic_constraints(
        ...
        builtins.int, global___QuadraticConstraintProto
    ]:
        ...
        """
    @property
    def second_order_cone_constraints(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[
        builtins.int, global___SecondOrderConeConstraintProto
    ]:
    ...
    def sos1_constraints(
        ...
        builtins.int, global___SosConstraintProto
    ]:
    ...
    def indicator_constraints(
        ...
        builtins.int, global___IndicatorConstraintProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        auxiliary_objectives: collections.abc.Mapping[
            builtins.int, global___ObjectiveProto
        ]
        | None = ...,
        linear_constraints: global___LinearConstraintsProto | None = ...,
        linear_constraint_matrix: ortools.service.v1.mathopt.sparse_containers_pb2.SparseDoubleMatrixProto
        | None = ...,
        quadratic_constraints: collections.abc.Mapping[
            builtins.int, global___QuadraticConstraintProto
        ]
        | None = ...,
        second_order_cone_constraints: collections.abc.Mapping[
            builtins.int, global___SecondOrderConeConstraintProto
        ]
        | None = ...,
        sos1_constraints: collections.abc.Mapping[
            builtins.int, global___SosConstraintProto
        ]
        | None = ...,
        sos2_constraints: collections.abc.Mapping[
            builtins.int, global___SosConstraintProto
        ]
        | None = ...,
        indicator_constraints: collections.abc.Mapping[
            builtins.int, global___IndicatorConstraintProto
        ]
        | None = ...,
    ) -> None: ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"linear_constraint_matrix",
            "linear_constraints",
            b"linear_constraints",
            "objective",
            b"objective",
            "variables",
            b"variables",
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"auxiliary_objectives",
            "indicator_constraints",
            b"indicator_constraints",
            "linear_constraint_matrix",
            b"linear_constraint_matrix",
            "linear_constraints",
            b"linear_constraints",
            ...
            b"quadratic_constraints",
            "second_order_cone_constraints",
            b"second_order_cone_constraints",
            "sos1_constraints",
            b"sos1_constraints",
            "sos2_constraints",
            b"sos2_constraints",

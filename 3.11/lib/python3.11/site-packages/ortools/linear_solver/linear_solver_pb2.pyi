...
class _MPSolverResponseStatusEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _MPSolverResponseStatus.ValueType
    ],
    builtins.type,
):
...
class MPSolverResponseStatus(
    _MPSolverResponseStatus, metaclass=_MPSolverResponseStatusEnumTypeWrapper
):
...
class MPGeneralConstraintProto(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["general_constraint", b"general_constraint"]
    ) -> (
        typing.Literal[
            "indicator_constraint",
            "sos_constraint",
...
class MPSosConstraint(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            MPSosConstraint._Type.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "type", b"type", "var_index", b"var_index", "weight", b"weight"
        ],
    ) -> None: ...
...
class MPAbsConstraint(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "resultant_var_index", b"resultant_var_index", "var_index", b"var_index"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MPArrayConstraint(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["resultant_var_index", b"resultant_var_index"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class MPArrayWithConstantConstraint(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "constant", b"constant", "resultant_var_index", b"resultant_var_index"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class PartialVariableAssignment(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "var_index", b"var_index", "var_value", b"var_value"
        ],
    ) -> None: ...
...
class MPModelProto(google.protobuf.message.Message):
    ...
    class Annotation(google.protobuf.message.Message):
        ...
        class _TargetTypeEnumTypeWrapper(
            google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
                MPModelProto.Annotation._TargetType.ValueType
            ],
            builtins.type,
        ):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    @property
    def general_constraint(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___MPGeneralConstraintProto
    ]:
    ...
    def annotation(
        ...
        global___MPModelProto.Annotation
    ]: ...
    def __init__(
        self,
        *,
        ...
        general_constraint: collections.abc.Iterable[global___MPGeneralConstraintProto]
        | None = ...,
        ...
        annotation: collections.abc.Iterable[global___MPModelProto.Annotation]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class MPSolverCommonParameters(google.protobuf.message.Message):
    ...
    class _LPAlgorithmValuesEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            MPSolverCommonParameters._LPAlgorithmValues.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class MPModelDeltaProto(google.protobuf.message.Message):
    ...
    def variable_overrides(
        ...
        builtins.int, global___MPVariableProto
    ]:
    ...
    def constraint_overrides(
        ...
        builtins.int, global___MPConstraintProto
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        variable_overrides: collections.abc.Mapping[
            builtins.int, global___MPVariableProto
        ]
        | None = ...,
        constraint_overrides: collections.abc.Mapping[
            builtins.int, global___MPConstraintProto
        ]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "baseline_model_file_path", b"baseline_model_file_path"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            ...
            b"baseline_model_file_path",
            "constraint_overrides",
            b"constraint_overrides",
            "variable_overrides",
            b"variable_overrides",
        ],
    ) -> None: ...
...
class MPModelRequest(google.protobuf.message.Message):
    ...
    class _SolverTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            MPModelRequest._SolverType.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"enable_internal_solver_output",
            "ignore_solver_specific_parameters_failure",
            b"ignore_solver_specific_parameters_failure",
            "model",
            b"model",
            "model_delta",
            b"model_delta",
            "populate_additional_solutions_up_to",
            b"populate_additional_solutions_up_to",
            "solver_specific_parameters",
            b"solver_specific_parameters",
            "solver_time_limit_seconds",
            b"solver_time_limit_seconds",
            "solver_type",
            b"solver_type",
        ],
    ) -> builtins.bool: ...
...
class MPSolution(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["objective_value", b"objective_value"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "objective_value", b"objective_value", "variable_value", b"variable_value"
        ],
    ) -> None: ...
...
class MPSolveInfo(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            b"solve_user_time_seconds",
            "solve_wall_time_seconds",
            b"solve_wall_time_seconds",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MPSolutionResponse(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        additional_solutions: collections.abc.Iterable[global___MPSolution]
        | None = ...,
    ) -> None: ...
    def HasField(
        self,

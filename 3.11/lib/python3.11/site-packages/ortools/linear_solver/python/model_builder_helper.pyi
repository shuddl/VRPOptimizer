...
class ModelBuilderHelper:
    ...
    def add_term_to_constraint(
        self, ct_index: int, var_index: int, coeff: float
    ) -> None: ...
    def add_term_to_enforced_constraint(
        self, ct_index: int, var_index: int, coeff: float
    ) -> None: ...
    def add_terms_to_constraint(
        self, arg0: int, arg1: list[int], arg2: list[float]
    ) -> None: ...
    ...
    def fill_model_from_sparse_data(
        self,
        variable_lower_bound: numpy.ndarray[numpy.float64[m, 1]],
        variable_upper_bound: numpy.ndarray[numpy.float64[m, 1]],
        objective_coefficients: numpy.ndarray[numpy.float64[m, 1]],
        constraint_lower_bounds: numpy.ndarray[numpy.float64[m, 1]],
        constraint_upper_bounds: numpy.ndarray[numpy.float64[m, 1]],
        constraint_matrix: scipy.sparse.csr_matrix[numpy.float64],
    ) -> None: ...
    ...
    def set_enforced_constraint_indicator_value(
        self, ct_index: int, positive: bool
    ) -> None: ...
    def set_enforced_constraint_indicator_variable_index(
        self, ct_index: int, var_index: int
    ) -> None: ...
    ...
    def set_objective_coefficients(
        self, arg0: list[int], arg1: list[float]
    ) -> None: ...
    ...
    def sort_and_regroup_terms(
        self, arg0: numpy.ndarray[numpy.int32], arg1: numpy.ndarray[numpy.float64]
    ...
    def write_to_mps_file(
        self, filename: str, options: MPModelExportOptions = ...
    ) -> bool: ...
...
class ModelSolverHelper:
    ...
    def expression_value(
        self, arg0: list[int], arg1: list[float], arg2: float
    ) -> float: ...
    ...
    def set_solver_specific_parameters(
        self, solver_specific_parameters: str
    ) -> None: ...

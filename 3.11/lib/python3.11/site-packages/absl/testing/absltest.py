...
def _monkey_patch_test_result_for_unexpected_passes():
    ...
    def wasSuccessful(self):
        ...
        """
        return (
            len(self.failures) == len(self.errors) == len(self.unexpectedSuccesses) == 0
        )
...
class _TempDir(object):
    ...
    def create_file(
        self, file_path=None, content=None, mode="w", encoding="utf8", errors="strict"
    ):
...
class _TempFile(object):
    ...
    def _open(
        ...
        with io.open(self.full_path, mode=mode, encoding=encoding, errors=errors) as fp:
            yield fp
...
class TestCase(unittest.TestCase):
    ...
    )  # type: TempFileCleanup  # pytype: disable=annotation-type-mismatch
    ...
    def assertLen(self, container, expected_len, msg=None):
        ...
        if len(container) != expected_len:
            container_repr = unittest.util.safe_repr(
                container
    ...
    def assertMultiLineEqual(self, first, second, msg=None, **kwargs):
        ...
        assert isinstance(first, str), "First argument is not a string: %r" % (first,)
    ...
    def assertCommandFails(self, command, regexes, env=None, close_fds=True, msg=None):
    ...
    def assertContainsExactSubsequence(self, container, subsequence, msg=None):
        ...
        if longest_match < len(subsequence):
            self.fail(
                "%s not an exact subsequence of %s. "
    ...
    def assertTotallyOrdered(self, *groups, **kwargs):
        ...
        def CheckOrder(small, big):
            ...
            self.assertFalse(
                big < small,
                self._formatMessage(msg, "%r unexpectedly less than %r" % (big, small)),
            )
        ...
        def CheckEqual(a, b):
            ...
            self.assertFalse(
                a != b, self._formatMessage(msg, "%r unexpectedly unequals %r" % (a, b))
            )
            ...
            self.assertFalse(
                a < b, self._formatMessage(msg, "%r unexpectedly less than %r" % (a, b))
            )
            self.assertFalse(
                b < a, self._formatMessage(msg, "%r unexpectedly less than %r" % (b, a))
            )
    ...
    def assertDictEqual(self, a, b, msg=None):
        ...
        self.assertIsInstance(
            a, dict, self._formatMessage(msg, "First argument is not a dictionary")
        )
        self.assertIsInstance(
            b, dict, self._formatMessage(msg, "Second argument is not a dictionary")
        )
    ...
    def assertUrlEqual(self, a, b, msg=None):
        ...
        self.assertEqual(
            sorted(parsed_a.params.split(";")), sorted(parsed_b.params.split(";")), msg
        )
    ...
    def assertJsonEqual(self, first, second, msg=None):
        ...
        self.assertSameStructure(
            first_structured, second_structured, aname="first", bname="second", msg=msg
        )
...
def print_python_version():
    ...
    sys.stderr.write(
        "Running tests under Python {0[0]}.{0[1]}.{0[2]}: "
        "{1}\n".format(
...
class TestLoader(unittest.TestLoader):
    ...
    _ERROR_MSG = textwrap.dedent(
        """Method '%s' is named like a test case but

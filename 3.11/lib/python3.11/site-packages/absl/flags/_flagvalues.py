...
class FlagValues:
    ...
    def _cleanup_unregistered_flag_from_module_dicts(self, flag_obj: Flag) -> None:
    ...
    def _register_unknown_flag_setter(self, setter: Callable[[str, Any], None]) -> None:
    ...
    def append_flag_values(self, flag_values: "FlagValues") -> None:
        ...
        for (
            flag_name,
            flag,
        ) in flag_values._flags().items():  # pylint: disable=protected-access

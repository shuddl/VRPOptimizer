...
class DaskNamespace:
    ...
    def concat(
        ...
        *,
        ...
        if how == "vertical":
            if not all(
                tuple(i.columns) == tuple(native_frames[0].columns)
                for i in native_frames
            ):  # pragma: no cover
    ...
    def _create_expr_from_series(self, _: Any) -> NoReturn:
        msg = (
            "`_create_expr_from_series` for DaskNamespace exists only for compatibility"
        )
        raise NotImplementedError(msg)

    def _create_compliant_series(self, _: Any) -> NoReturn:
        msg = (
            "`_create_compliant_series` for DaskNamespace exists only for compatibility"
        )
        raise NotImplementedError(msg)
    ...
    def _create_series_from_scalar(
        ...
        msg = "`_create_series_from_scalar` for DaskNamespace exists only for compatibility"
        raise NotImplementedError(msg)
    ...
    def _create_expr_from_callable(  # pragma: no cover
        ...
        *,
        ...
        msg = "`_create_expr_from_callable` for DaskNamespace exists only for compatibility"
        raise NotImplementedError(msg)
